...
//  Lissic
//
//  Created by Jeffery Jackson, Jr. on 5/5/17.
...
public class StyleKit : NSObject {
    ...
    private struct Cache {
        static let lightTintColor: UIColor = UIColor(red: 0.510, green: 0.804, blue: 0.902, alpha: 1.000)
        ...
        static let darkBackgroundColor: UIColor = UIColor(red: 0.133, green: 0.133, blue: 0.133, alpha: 1.000)
        static let lightBackdropOverlayColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.750)
        static let lightBackgroundColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)
        static let darkTintColor: UIColor = UIColor(red: 0.188, green: 0.392, blue: 0.518, alpha: 1.000)
    ...
    public dynamic class func drawLightBackdrop(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1024, height: 1024), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 651.26, y: 913.64))
        bezierPath.addCurve(to: CGPoint(x: 780.79, y: 660.23), controlPoint1: CGPoint(x: 588.65, y: 936.06), controlPoint2: CGPoint(x: 778.95, y: 836.03))
        bezierPath.addCurve(to: CGPoint(x: 624.08, y: 365.52), controlPoint1: CGPoint(x: 781.89, y: 554.92), controlPoint2: CGPoint(x: 717.85, y: 474.51))
        bezierPath.addCurve(to: CGPoint(x: 514.33, y: 186.96), controlPoint1: CGPoint(x: 523.53, y: 248.67), controlPoint2: CGPoint(x: 527.69, y: 187.38))
        bezierPath.addCurve(to: CGPoint(x: 407.09, y: 365.52), controlPoint1: CGPoint(x: 502.87, y: 186.61), controlPoint2: CGPoint(x: 505.48, y: 248.75))
        bezierPath.addCurve(to: CGPoint(x: 245.56, y: 660.23), controlPoint1: CGPoint(x: 321.23, y: 467.43), controlPoint2: CGPoint(x: 247.72, y: 543.74))
        bezierPath.addCurve(to: CGPoint(x: 373.83, y: 914.02), controlPoint1: CGPoint(x: 242.39, y: 830.6), controlPoint2: CGPoint(x: 436.5, y: 935.58))
        bezierPath.addCurve(to: CGPoint(x: 87, y: 512.02), controlPoint1: CGPoint(x: 207.01, y: 856.62), controlPoint2: CGPoint(x: 87, y: 698.22))
        bezierPath.addCurve(to: CGPoint(x: 512, y: 87.02), controlPoint1: CGPoint(x: 87, y: 277.46), controlPoint2: CGPoint(x: 277.44, y: 87.02))
        bezierPath.addCurve(to: CGPoint(x: 937, y: 512.02), controlPoint1: CGPoint(x: 746.56, y: 87.02), controlPoint2: CGPoint(x: 937, y: 277.46))
        bezierPath.addCurve(to: CGPoint(x: 651.26, y: 913.64), controlPoint1: CGPoint(x: 937, y: 697.81), controlPoint2: CGPoint(x: 816.94, y: 854.3))
        bezierPath.close()
        ...
        bezier2Path.move(to: CGPoint(x: 506.22, y: 936.98))
        bezier2Path.addCurve(to: CGPoint(x: 411.03, y: 881.49), controlPoint1: CGPoint(x: 464.6, y: 936.98), controlPoint2: CGPoint(x: 419.5, y: 919.84))
        bezier2Path.addCurve(to: CGPoint(x: 408.8, y: 861.95), controlPoint1: CGPoint(x: 409.75, y: 875.71), controlPoint2: CGPoint(x: 408.83, y: 866.71))
        bezier2Path.addCurve(to: CGPoint(x: 556.5, y: 763.06), controlPoint1: CGPoint(x: 408.11, y: 745.74), controlPoint2: CGPoint(x: 562.01, y: 775.14))
        bezier2Path.addCurve(to: CGPoint(x: 424.24, y: 520.62), controlPoint1: CGPoint(x: 529.28, y: 703.36), controlPoint2: CGPoint(x: 485.36, y: 618.97))
        bezier2Path.addCurve(to: CGPoint(x: 411.73, y: 471.78), controlPoint1: CGPoint(x: 409.05, y: 496.17), controlPoint2: CGPoint(x: 405.28, y: 484.17))
        bezier2Path.addCurve(to: CGPoint(x: 449.17, y: 450.76), controlPoint1: CGPoint(x: 417.44, y: 460.82), controlPoint2: CGPoint(x: 440.07, y: 454.12))
        bezier2Path.addCurve(to: CGPoint(x: 552.98, y: 415.43), controlPoint1: CGPoint(x: 488.8, y: 436.1), controlPoint2: CGPoint(x: 495.65, y: 433.07))
        bezier2Path.addCurve(to: CGPoint(x: 585.35, y: 421.03), controlPoint1: CGPoint(x: 569.5, y: 410.35), controlPoint2: CGPoint(x: 574.25, y: 409.84))
        bezier2Path.addCurve(to: CGPoint(x: 631.31, y: 471.78), controlPoint1: CGPoint(x: 598.18, y: 433.95), controlPoint2: CGPoint(x: 613.81, y: 448.72))
        bezier2Path.addCurve(to: CGPoint(x: 597.96, y: 524.64), controlPoint1: CGPoint(x: 652.78, y: 500.06), controlPoint2: CGPoint(x: 651.84, y: 511.61))
        bezier2Path.addCurve(to: CGPoint(x: 496.55, y: 558.4), controlPoint1: CGPoint(x: 552, y: 535.75), controlPoint2: CGPoint(x: 489.39, y: 545.37))
        bezier2Path.addCurve(to: CGPoint(x: 585.23, y: 728.19), controlPoint1: CGPoint(x: 502.96, y: 570.06), controlPoint2: CGPoint(x: 548.76, y: 654.06))
        bezier2Path.addCurve(to: CGPoint(x: 618.56, y: 834.96), controlPoint1: CGPoint(x: 602.3, y: 762.88), controlPoint2: CGPoint(x: 618.56, y: 802.5))
        bezier2Path.addCurve(to: CGPoint(x: 506.22, y: 936.98), controlPoint1: CGPoint(x: 618.56, y: 893.24), controlPoint2: CGPoint(x: 591.72, y: 936.98))
        bezier2Path.close()
    ...
    public dynamic class func drawDarkBackdrop(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1024, height: 1024), resizing: ResizingBehavior = .aspectFit) {
        ...
        bezier3Path.addCurve(to: CGPoint(x: 780.79, y: 660.23), controlPoint1: CGPoint(x: 588.65, y: 936.06), controlPoint2: CGPoint(x: 778.95, y: 836.03))
        bezier3Path.addCurve(to: CGPoint(x: 624.08, y: 365.52), controlPoint1: CGPoint(x: 781.89, y: 554.93), controlPoint2: CGPoint(x: 717.85, y: 474.51))
        bezier3Path.addCurve(to: CGPoint(x: 514.33, y: 186.97), controlPoint1: CGPoint(x: 523.53, y: 248.67), controlPoint2: CGPoint(x: 527.69, y: 187.38))
        ...
        bezier3Path.addCurve(to: CGPoint(x: 245.56, y: 660.23), controlPoint1: CGPoint(x: 321.23, y: 467.43), controlPoint2: CGPoint(x: 247.72, y: 543.74))
        bezier3Path.addCurve(to: CGPoint(x: 373.83, y: 914.02), controlPoint1: CGPoint(x: 242.39, y: 830.6), controlPoint2: CGPoint(x: 436.5, y: 935.58))
        ...
        bezier3Path.addCurve(to: CGPoint(x: 651.26, y: 913.64), controlPoint1: CGPoint(x: 937, y: 697.82), controlPoint2: CGPoint(x: 816.94, y: 854.3))
        bezier3Path.close()
        ...
        bezier4Path.addCurve(to: CGPoint(x: 449.17, y: 450.76), controlPoint1: CGPoint(x: 417.44, y: 460.82), controlPoint2: CGPoint(x: 440.07, y: 454.13))
        bezier4Path.addCurve(to: CGPoint(x: 552.98, y: 415.44), controlPoint1: CGPoint(x: 488.8, y: 436.1), controlPoint2: CGPoint(x: 495.65, y: 433.07))
        ...
        bezier4Path.addCurve(to: CGPoint(x: 631.31, y: 471.78), controlPoint1: CGPoint(x: 598.18, y: 433.96), controlPoint2: CGPoint(x: 613.81, y: 448.72))
        bezier4Path.addCurve(to: CGPoint(x: 597.96, y: 524.64), controlPoint1: CGPoint(x: 652.78, y: 500.07), controlPoint2: CGPoint(x: 651.84, y: 511.61))
