...
class SettingsViewController: LissicViewController {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		case 0: // DISPLAY OPTIONS
			...
			case 1: // THEME MODE DETERMINER OR ADAPTIVE ARTIST VIEW
				if PreferenceManager.shared.themeMode == .auto {
					cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ThemeDeterminerDisplayBrightnessCell", for: indexPath) as! LissicCollectionViewCell
