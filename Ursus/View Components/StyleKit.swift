...
public class StyleKit : NSObject {
    ...
    public dynamic class func drawLightBackdrop(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1024, height: 1024), resizing: ResizingBehavior = .aspectFit) {
        ...
        mountainPath.move(to: CGPoint(x: 558.27, y: 554.53))
        mountainPath.addCurve(to: CGPoint(x: 707.02, y: 771.07), controlPoint1: CGPoint(x: 592.27, y: 607.69), controlPoint2: CGPoint(x: 674.6, y: 727.67))
        mountainPath.addCurve(to: CGPoint(x: 767, y: 711), controlPoint1: CGPoint(x: 740.21, y: 737.57), controlPoint2: CGPoint(x: 765.66, y: 712.01))
        mountainPath.addCurve(to: CGPoint(x: 809, y: 693), controlPoint1: CGPoint(x: 771, y: 708), controlPoint2: CGPoint(x: 800, y: 690))
        mountainPath.addCurve(to: CGPoint(x: 928, y: 836.17), controlPoint1: CGPoint(x: 818, y: 696), controlPoint2: CGPoint(x: 922, y: 830.34))
        mountainPath.addCurve(to: CGPoint(x: 1001, y: 868), controlPoint1: CGPoint(x: 934, y: 842), controlPoint2: CGPoint(x: 991, y: 858))
        mountainPath.addCurve(to: CGPoint(x: 1068, y: 976), controlPoint1: CGPoint(x: 1011, y: 878), controlPoint2: CGPoint(x: 1068, y: 976))
        mountainPath.addLine(to: CGPoint(x: 1102, y: 1028))
        mountainPath.addLine(to: CGPoint(x: -77, y: 1028))
        mountainPath.addCurve(to: CGPoint(x: -7, y: 930), controlPoint1: CGPoint(x: -77, y: 1028), controlPoint2: CGPoint(x: -23, y: 944))
        mountainPath.addCurve(to: CGPoint(x: 102, y: 894), controlPoint1: CGPoint(x: 9, y: 916), controlPoint2: CGPoint(x: 96, y: 900))
        mountainPath.addCurve(to: CGPoint(x: 204, y: 780), controlPoint1: CGPoint(x: 108, y: 888), controlPoint2: CGPoint(x: 188, y: 789))
        mountainPath.addCurve(to: CGPoint(x: 286, y: 780), controlPoint1: CGPoint(x: 220, y: 771), controlPoint2: CGPoint(x: 272, y: 787))
        mountainPath.addCurve(to: CGPoint(x: 386, y: 679), controlPoint1: CGPoint(x: 300, y: 773), controlPoint2: CGPoint(x: 386, y: 679))
        mountainPath.addCurve(to: CGPoint(x: 501, y: 518), controlPoint1: CGPoint(x: 386, y: 679), controlPoint2: CGPoint(x: 486, y: 517))
        mountainPath.addCurve(to: CGPoint(x: 558.27, y: 554.53), controlPoint1: CGPoint(x: 516, y: 519), controlPoint2: CGPoint(x: 517, y: 490))
        mountainPath.close()
