...
public class StyleKit : NSObject {
    ...
    private struct Cache {
        ...
        static let darkBackgroundColor: UIColor = UIColor(red: 0.102, green: 0.110, blue: 0.125, alpha: 1.000)
        ...
        static let lightBackdropOverlayColor: UIColor = StyleKit.lightBackgroundColor.withAlpha(0.8)
    ...
    public dynamic class func drawBackIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 120, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    public dynamic class func drawDarkBackdrop(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1024, height: 1024), resizing: ResizingBehavior = .aspectFit) {
        ...
        cityscapePath.move(to: CGPoint(x: 1024, y: 1024))
        cityscapePath.addLine(to: CGPoint(x: 0, y: 1024))
        cityscapePath.addLine(to: CGPoint(x: 0.16, y: 977.81))
        cityscapePath.addLine(to: CGPoint(x: 210.61, y: 977.52))
        cityscapePath.addLine(to: CGPoint(x: 211.75, y: 760.95))
        cityscapePath.addLine(to: CGPoint(x: 223.2, y: 760.95))
        cityscapePath.addLine(to: CGPoint(x: 222.79, y: 737.25))
        cityscapePath.addLine(to: CGPoint(x: 262.53, y: 647.38))
        cityscapePath.addLine(to: CGPoint(x: 302.69, y: 737.2))
        cityscapePath.addLine(to: CGPoint(x: 302.76, y: 760.95))
        cityscapePath.addLine(to: CGPoint(x: 312.67, y: 760.95))
        cityscapePath.addLine(to: CGPoint(x: 312.67, y: 951.59))
        cityscapePath.addLine(to: CGPoint(x: 387.65, y: 951.59))
        cityscapePath.addLine(to: CGPoint(x: 387.65, y: 866.54))
        cityscapePath.addLine(to: CGPoint(x: 500.41, y: 866.53))
        cityscapePath.addLine(to: CGPoint(x: 500.4, y: 732.71))
        cityscapePath.addLine(to: CGPoint(x: 526.08, y: 732.71))
        cityscapePath.addLine(to: CGPoint(x: 526.08, y: 689.07))
        cityscapePath.addLine(to: CGPoint(x: 626.27, y: 689.07))
        cityscapePath.addLine(to: CGPoint(x: 626.27, y: 732.71))
        cityscapePath.addLine(to: CGPoint(x: 649.68, y: 732.71))
        cityscapePath.addLine(to: CGPoint(x: 649.7, y: 977.81))
        cityscapePath.addLine(to: CGPoint(x: 698.06, y: 977.52))
        cityscapePath.addLine(to: CGPoint(x: 696.06, y: 854.47))
        cityscapePath.addLine(to: CGPoint(x: 726.63, y: 854.47))
        cityscapePath.addLine(to: CGPoint(x: 726.63, y: 782.79))
        cityscapePath.addLine(to: CGPoint(x: 790.08, y: 782.79))
        cityscapePath.addLine(to: CGPoint(x: 790.08, y: 854.47))
        cityscapePath.addLine(to: CGPoint(x: 819.87, y: 854.47))
        cityscapePath.addLine(to: CGPoint(x: 819.87, y: 977.52))
        cityscapePath.addLine(to: CGPoint(x: 1024, y: 977.52))
        cityscapePath.addLine(to: CGPoint(x: 1024, y: 1024))
        cityscapePath.close()
