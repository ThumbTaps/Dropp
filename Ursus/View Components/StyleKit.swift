...
//  Ursus
//
//  Created by Jeffery Jackson, Jr. on 1/11/17.
...
public class StyleKit : NSObject {
    ...
    private struct Cache {
        ...
        static let darkTintColor: UIColor = UIColor(red: 0.653, green: 0.645, blue: 0.609, alpha: 1.000)
        static let darkIconGlyphColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.500)
        static let darkCloudColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.600)
        ...
        static let darkBackdropOverlayColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.900)
        static let lightBackdropOverlayColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.800)
        static let lightPrimaryTextColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)
        static let lightSecondaryTextColor: UIColor = StyleKit.lightPrimaryTextColor.withBrightness(0.5)
        static let lightTertiaryTextColor: UIColor = StyleKit.lightPrimaryTextColor.withBrightness(0.8)
        static let darkPrimaryTextColor: UIColor = UIColor(red: 0.941, green: 0.941, blue: 0.941, alpha: 1.000)
        static let darkSecondaryTextColor: UIColor = StyleKit.darkPrimaryTextColor.withBrightness(0.5)
        static let darkTertiaryTextColor: UIColor = StyleKit.darkPrimaryTextColor.withBrightness(0.25)
        static var imageOfLightPlaceholderAlbumArtwork: UIImage?
        static var lightPlaceholderAlbumArtworkTargets: [AnyObject]?
        static var imageOfDarkPlaceholderAlbumArtwork: UIImage?
        static var darkPlaceholderAlbumArtworkTargets: [AnyObject]?
    }
    ...
    public dynamic class func drawBackIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 200, height: 300), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 200, y: resizedFrame.height / 300)


        //// chevron Drawing
        context.saveGState()
        context.translateBy(x: 121.92, y: 150.57)
    ...
    public dynamic class func drawDarkBackdrop(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1024, height: 1024), resizing: ResizingBehavior = .aspectFit) {
        ...
        musicSymbolPath.move(to: CGPoint(x: 423.8, y: 673.34))
        musicSymbolPath.addCurve(to: CGPoint(x: 352.22, y: 739.06), controlPoint1: CGPoint(x: 423.42, y: 697.18), controlPoint2: CGPoint(x: 411.8, y: 735.17))
        musicSymbolPath.addCurve(to: CGPoint(x: 299.03, y: 705.58), controlPoint1: CGPoint(x: 332.82, y: 740.32), controlPoint2: CGPoint(x: 301.26, y: 731.12))
        musicSymbolPath.addLine(to: CGPoint(x: 298.13, y: 695.29))
        musicSymbolPath.addCurve(to: CGPoint(x: 397.52, y: 622.7), controlPoint1: CGPoint(x: 298.95, y: 615.68), controlPoint2: CGPoint(x: 393.55, y: 640.93))
        musicSymbolPath.addCurve(to: CGPoint(x: 397.52, y: 386.82), controlPoint1: CGPoint(x: 406.57, y: 581.13), controlPoint2: CGPoint(x: 397.52, y: 386.82))
        musicSymbolPath.addLine(to: CGPoint(x: 397.52, y: 353.65))
        musicSymbolPath.addCurve(to: CGPoint(x: 411.3, y: 339.86), controlPoint1: CGPoint(x: 397.52, y: 346.04), controlPoint2: CGPoint(x: 405.05, y: 341.61))
        musicSymbolPath.addCurve(to: CGPoint(x: 627.7, y: 284.96), controlPoint1: CGPoint(x: 451.27, y: 328.68), controlPoint2: CGPoint(x: 587.54, y: 293.82))
        musicSymbolPath.addCurve(to: CGPoint(x: 641.49, y: 298.74), controlPoint1: CGPoint(x: 634.05, y: 283.56), controlPoint2: CGPoint(x: 641.49, y: 291.13))
        musicSymbolPath.addLine(to: CGPoint(x: 641.49, y: 363.08))
        musicSymbolPath.addLine(to: CGPoint(x: 641.49, y: 599.88))
        musicSymbolPath.addCurve(to: CGPoint(x: 641.48, y: 600.23), controlPoint1: CGPoint(x: 641.49, y: 600), controlPoint2: CGPoint(x: 641.48, y: 600.11))
        musicSymbolPath.addCurve(to: CGPoint(x: 561.28, y: 665.94), controlPoint1: CGPoint(x: 641.1, y: 624.07), controlPoint2: CGPoint(x: 622.2, y: 663.73))
        musicSymbolPath.addCurve(to: CGPoint(x: 513.53, y: 632.47), controlPoint1: CGPoint(x: 541.86, y: 666.65), controlPoint2: CGPoint(x: 515.76, y: 658.01))
        musicSymbolPath.addLine(to: CGPoint(x: 512.63, y: 622.18))
        musicSymbolPath.addCurve(to: CGPoint(x: 620.07, y: 549.58), controlPoint1: CGPoint(x: 514.94, y: 551.81), controlPoint2: CGPoint(x: 619.34, y: 566.32))
        musicSymbolPath.addCurve(to: CGPoint(x: 620.1, y: 384.7), controlPoint1: CGPoint(x: 621.43, y: 518.81), controlPoint2: CGPoint(x: 620.45, y: 412.51))
        musicSymbolPath.addCurve(to: CGPoint(x: 617.99, y: 382.73), controlPoint1: CGPoint(x: 620.09, y: 383.74), controlPoint2: CGPoint(x: 618.93, y: 382.55))
        musicSymbolPath.addCurve(to: CGPoint(x: 425.54, y: 425.98), controlPoint1: CGPoint(x: 585.7, y: 389), controlPoint2: CGPoint(x: 459.5, y: 418.75))
        musicSymbolPath.addCurve(to: CGPoint(x: 423.81, y: 427.76), controlPoint1: CGPoint(x: 424.73, y: 426.15), controlPoint2: CGPoint(x: 423.82, y: 426.93))
        musicSymbolPath.addCurve(to: CGPoint(x: 423.81, y: 672.99), controlPoint1: CGPoint(x: 423.52, y: 468.93), controlPoint2: CGPoint(x: 423.81, y: 672.99))
        musicSymbolPath.addCurve(to: CGPoint(x: 423.8, y: 673.34), controlPoint1: CGPoint(x: 423.81, y: 673.11), controlPoint2: CGPoint(x: 423.81, y: 673.22))
        ...
        //// cityscape Drawing
        let cityscapePath = UIBezierPath()
        cityscapePath.move(to: CGPoint(x: 1032.6, y: 1033.39))
        cityscapePath.addLine(to: CGPoint(x: -3.16, y: 1033.39))
        cityscapePath.addLine(to: CGPoint(x: -3.16, y: 942.71))
        cityscapePath.addLine(to: CGPoint(x: 209.87, y: 942.71))
        cityscapePath.addLine(to: CGPoint(x: 211.02, y: 763.78))
        cityscapePath.addLine(to: CGPoint(x: 222.6, y: 763.78))
        cityscapePath.addLine(to: CGPoint(x: 222.19, y: 739.49))
        cityscapePath.addLine(to: CGPoint(x: 262.39, y: 647.38))
        cityscapePath.addLine(to: CGPoint(x: 303.01, y: 739.44))
        cityscapePath.addLine(to: CGPoint(x: 303.08, y: 763.78))
        cityscapePath.addLine(to: CGPoint(x: 313.1, y: 763.78))
        cityscapePath.addLine(to: CGPoint(x: 313.1, y: 916.13))
        cityscapePath.addLine(to: CGPoint(x: 388.94, y: 916.13))
        cityscapePath.addLine(to: CGPoint(x: 388.94, y: 872))
        cityscapePath.addLine(to: CGPoint(x: 504.57, y: 872))
        cityscapePath.addLine(to: CGPoint(x: 502.98, y: 734.84))
        cityscapePath.addLine(to: CGPoint(x: 528.96, y: 734.84))
        cityscapePath.addLine(to: CGPoint(x: 528.96, y: 690.11))
        cityscapePath.addLine(to: CGPoint(x: 630.3, y: 690.11))
        cityscapePath.addLine(to: CGPoint(x: 630.3, y: 734.84))
        cityscapePath.addLine(to: CGPoint(x: 653.97, y: 734.84))
        cityscapePath.addLine(to: CGPoint(x: 653.97, y: 901.13))
        cityscapePath.addLine(to: CGPoint(x: 654.2, y: 901.13))
        cityscapePath.addLine(to: CGPoint(x: 656.23, y: 942.71))
        cityscapePath.addLine(to: CGPoint(x: 702.91, y: 942.71))
        cityscapePath.addLine(to: CGPoint(x: 700.89, y: 859.64))
        cityscapePath.addLine(to: CGPoint(x: 731.81, y: 859.64))
        cityscapePath.addLine(to: CGPoint(x: 731.81, y: 786.17))
        cityscapePath.addLine(to: CGPoint(x: 795.99, y: 786.17))
        cityscapePath.addLine(to: CGPoint(x: 795.99, y: 859.64))
        cityscapePath.addLine(to: CGPoint(x: 826.13, y: 859.64))
        cityscapePath.addLine(to: CGPoint(x: 826.13, y: 942.71))
        cityscapePath.addLine(to: CGPoint(x: 1032.6, y: 942.71))
        cityscapePath.addLine(to: CGPoint(x: 1032.6, y: 1033.39))
        cityscapePath.close()
        cityscapePath.usesEvenOddFillRule = true
        black.setFill()
        cityscapePath.fill()
        ...
        cloudPath.move(to: CGPoint(x: 741.79, y: 1125.31))
        cloudPath.addCurve(to: CGPoint(x: 508.9, y: 1304.86), controlPoint1: CGPoint(x: 705.66, y: 1229.77), controlPoint2: CGPoint(x: 625.6, y: 1304.86))
        cloudPath.addCurve(to: CGPoint(x: 241.28, y: 1167.6), controlPoint1: CGPoint(x: 408.65, y: 1304.86), controlPoint2: CGPoint(x: 286.83, y: 1249.44))
        cloudPath.addCurve(to: CGPoint(x: 99.95, y: 1210.77), controlPoint1: CGPoint(x: 200.92, y: 1194.85), controlPoint2: CGPoint(x: 152.28, y: 1210.77))
        cloudPath.addCurve(to: CGPoint(x: -153, y: 957.9), controlPoint1: CGPoint(x: -39.65, y: 1210.77), controlPoint2: CGPoint(x: -153, y: 1097.46))
        cloudPath.addCurve(to: CGPoint(x: 36.93, y: 722.05), controlPoint1: CGPoint(x: -153, y: 850.53), controlPoint2: CGPoint(x: -57.58, y: 758.7))
        cloudPath.addCurve(to: CGPoint(x: 32.21, y: 669.74), controlPoint1: CGPoint(x: 33.83, y: 705.08), controlPoint2: CGPoint(x: 32.21, y: 687.6))
        cloudPath.addCurve(to: CGPoint(x: 294.08, y: 379.62), controlPoint1: CGPoint(x: 32.21, y: 509.62), controlPoint2: CGPoint(x: 135.41, y: 401.47))
        cloudPath.addCurve(to: CGPoint(x: 586.18, y: 516.7), controlPoint1: CGPoint(x: 418.63, y: 362.46), controlPoint2: CGPoint(x: 534.93, y: 434.43))
        cloudPath.addCurve(to: CGPoint(x: 755.34, y: 426.66), controlPoint1: CGPoint(x: 622.83, y: 462.4), controlPoint2: CGPoint(x: 684.94, y: 426.66))
        cloudPath.addCurve(to: CGPoint(x: 928.91, y: 630.53), controlPoint1: CGPoint(x: 867.9, y: 426.66), controlPoint2: CGPoint(x: 928.91, y: 518.01))
        cloudPath.addLine(to: CGPoint(x: 928.91, y: 631.53))
        cloudPath.addCurve(to: CGPoint(x: 1179.9, y: 904.97), controlPoint1: CGPoint(x: 1069.42, y: 643.47), controlPoint2: CGPoint(x: 1179.9, y: 761.42))
        cloudPath.addCurve(to: CGPoint(x: 905.38, y: 1179.41), controlPoint1: CGPoint(x: 1179.9, y: 1056.44), controlPoint2: CGPoint(x: 1056.89, y: 1179.41))
        cloudPath.addCurve(to: CGPoint(x: 741.79, y: 1125.31), controlPoint1: CGPoint(x: 844.1, y: 1179.41), controlPoint2: CGPoint(x: 787.49, y: 1159.29))
        cloudPath.close()
    ...
    public dynamic class func drawLightBackdrop(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1024, height: 1024), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// bg Drawing
        let bgPath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 1024, height: 1024))
        StyleKit.lightBackgroundColor.setFill()
        bgPath.fill()
    ...
    public dynamic class func drawLightPlaceholderAlbumArtwork(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    public dynamic class func drawDarkPlaceholderAlbumArtwork(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    public dynamic class var imageOfLightPlaceholderAlbumArtwork: UIImage {
        if Cache.imageOfLightPlaceholderAlbumArtwork != nil {
            return Cache.imageOfLightPlaceholderAlbumArtwork!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 300, height: 300), false, 0)
            StyleKit.drawLightPlaceholderAlbumArtwork()

        Cache.imageOfLightPlaceholderAlbumArtwork = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfLightPlaceholderAlbumArtwork!
    }

    public dynamic class var imageOfDarkPlaceholderAlbumArtwork: UIImage {
        if Cache.imageOfDarkPlaceholderAlbumArtwork != nil {
            return Cache.imageOfDarkPlaceholderAlbumArtwork!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 300, height: 300), false, 0)
            StyleKit.drawDarkPlaceholderAlbumArtwork()

        Cache.imageOfDarkPlaceholderAlbumArtwork = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @IBOutlet dynamic var lightPlaceholderAlbumArtworkTargets: [AnyObject]! {
        get { return Cache.lightPlaceholderAlbumArtworkTargets }
        set {
            Cache.lightPlaceholderAlbumArtworkTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: StyleKit.imageOfLightPlaceholderAlbumArtwork)
            }
        }
    }

    @IBOutlet dynamic var darkPlaceholderAlbumArtworkTargets: [AnyObject]! {
        get { return Cache.darkPlaceholderAlbumArtworkTargets }
        set {
            Cache.darkPlaceholderAlbumArtworkTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: StyleKit.imageOfDarkPlaceholderAlbumArtwork)
            }
        }
    }
