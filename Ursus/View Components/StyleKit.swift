...
public class StyleKit : NSObject {
    ...
    private struct Cache {
        ...
        static let darkTintColor: UIColor = UIColor(red: 0.714, green: 0.702, blue: 0.659, alpha: 1.000)
        ...
        static let darkBackdropOverlayColor: UIColor = StyleKit.darkBackgroundColor.withAlpha(0.95)
    ...
    public dynamic class func imageOfSortIcon(iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 300, height: 300), false, 0)
            StyleKit.drawSortIcon(iconColor: iconColor)

        let imageOfSortIcon = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfSortIcon
    }

    public dynamic class func imageOfMoreIcon(iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 300, height: 300), false, 0)
            StyleKit.drawMoreIcon(iconColor: iconColor)

        let imageOfMoreIcon = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
