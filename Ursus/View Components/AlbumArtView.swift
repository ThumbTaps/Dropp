...
class AlbumArtView: UIView {
	...
	@IBOutlet weak var imageView: AlbumArtViewImageView!
	...
	override func draw(_ rect: CGRect) {
		...
		if PreferenceManager.shared.themeMode == .dark {
			StyleKit.drawDarkPlaceholderAlbumArtwork(frame: rect, resizing: .aspectFit)
			self.layer.borderColor = StyleKit.darkStrokeColor.cgColor
		} else {
			StyleKit.drawLightPlaceholderAlbumArtwork(frame: rect, resizing: .aspectFit)
...
@IBDesignable
class AlbumArtViewImageView: UIImageView {
