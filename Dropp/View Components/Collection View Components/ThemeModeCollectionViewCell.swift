...
@IBDesignable
class ThemeModeCollectionViewCell: DroppCollectionViewCell, UIGestureRecognizerDelegate {
	...
	@IBInspectable var selected: Bool = false {
		didSet {
			if self.selected {
				...
				UIViewPropertyAnimator(duration: 0.25 * ANIMATION_SPEED_MODIFIER, curve: .easeOut, animations: {
