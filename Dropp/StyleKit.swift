...
public class StyleKit : NSObject {
    ...
    private struct Cache {
        static let lightTintColor: UIColor = UIColor(red: 0.106, green: 0.325, blue: 0.557, alpha: 1.000)
        static let lightGlyphColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.900)
        static let darkBackdropOverlayColor: UIColor = StyleKit.darkBackgroundColor.withAlpha(0.85)
        static let darkBackgroundColor: UIColor = UIColor(red: 0.094, green: 0.118, blue: 0.129, alpha: 1.000)
        static let lightBackdropOverlayColor: UIColor = StyleKit.lightBackgroundColor.withAlpha(0.85)
        ...
        static let darkStrokeColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.200)
        ...
        static let lightShadowColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.200)
        static let darkShadowColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.500)
        static let lightNotificationColor: UIColor = UIColor(red: 0.968, green: 0.690, blue: 0.155, alpha: 1.000)
        static let darkNotificationColor: UIColor = StyleKit.lightNotificationColor.shadow(withLevel: 0.2)
    }

    //// Colors

    @objc dynamic public class var lightTintColor: UIColor { return Cache.lightTintColor }
    @objc dynamic public class var lightGlyphColor: UIColor { return Cache.lightGlyphColor }
    @objc dynamic public class var darkBackdropOverlayColor: UIColor { return Cache.darkBackdropOverlayColor }
    @objc dynamic public class var darkBackgroundColor: UIColor { return Cache.darkBackgroundColor }
    @objc dynamic public class var lightBackdropOverlayColor: UIColor { return Cache.lightBackdropOverlayColor }
    @objc dynamic public class var lightBackgroundColor: UIColor { return Cache.lightBackgroundColor }
    @objc dynamic public class var darkTintColor: UIColor { return Cache.darkTintColor }
    @objc dynamic public class var darkGlyphColor: UIColor { return Cache.darkGlyphColor }
    @objc dynamic public class var lightStrokeColor: UIColor { return Cache.lightStrokeColor }
    @objc dynamic public class var darkStrokeColor: UIColor { return Cache.darkStrokeColor }
    @objc dynamic public class var lightPrimaryTextColor: UIColor { return Cache.lightPrimaryTextColor }
    @objc dynamic public class var lightSecondaryTextColor: UIColor { return Cache.lightSecondaryTextColor }
    @objc dynamic public class var lightTertiaryTextColor: UIColor { return Cache.lightTertiaryTextColor }
    @objc dynamic public class var darkPrimaryTextColor: UIColor { return Cache.darkPrimaryTextColor }
    @objc dynamic public class var darkSecondaryTextColor: UIColor { return Cache.darkSecondaryTextColor }
    @objc dynamic public class var darkTertiaryTextColor: UIColor { return Cache.darkTertiaryTextColor }
    @objc dynamic public class var lightShadowColor: UIColor { return Cache.lightShadowColor }
    @objc dynamic public class var darkShadowColor: UIColor { return Cache.darkShadowColor }
    @objc dynamic public class var lightNotificationColor: UIColor { return Cache.lightNotificationColor }
    @objc dynamic public class var darkNotificationColor: UIColor { return Cache.darkNotificationColor }

    //// Drawing Methods

    @objc dynamic public class func drawSearchIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawLeftIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawPlaceholderReleaseArtwork(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawSettingsIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 157.03, y: 242.81))
        bezierPath.addLine(to: CGPoint(x: 143.3, y: 242.81))
        bezierPath.addCurve(to: CGPoint(x: 126.21, y: 221.91), controlPoint1: CGPoint(x: 129.82, y: 242.7), controlPoint2: CGPoint(x: 130.72, y: 226.08))
        bezierPath.addCurve(to: CGPoint(x: 116.28, y: 217.82), controlPoint1: CGPoint(x: 123.58, y: 219.48), controlPoint2: CGPoint(x: 119.86, y: 217.95))
        bezierPath.addCurve(to: CGPoint(x: 89.35, y: 220.6), controlPoint1: CGPoint(x: 110.13, y: 217.6), controlPoint2: CGPoint(x: 98.85, y: 229.54))
        bezierPath.addLine(to: CGPoint(x: 79.64, y: 210.89))
        bezierPath.addCurve(to: CGPoint(x: 82.33, y: 184.03), controlPoint1: CGPoint(x: 70.18, y: 201.28), controlPoint2: CGPoint(x: 82.57, y: 190.16))
        bezierPath.addCurve(to: CGPoint(x: 78.2, y: 174.11), controlPoint1: CGPoint(x: 82.19, y: 180.45), controlPoint2: CGPoint(x: 80.64, y: 176.73))
        bezierPath.addCurve(to: CGPoint(x: 57.19, y: 157.03), controlPoint1: CGPoint(x: 74.01, y: 169.61), controlPoint2: CGPoint(x: 57.58, y: 170.07))
        bezierPath.addLine(to: CGPoint(x: 57.19, y: 143.3))
        bezierPath.addCurve(to: CGPoint(x: 78.09, y: 126.21), controlPoint1: CGPoint(x: 57.3, y: 129.82), controlPoint2: CGPoint(x: 73.92, y: 130.72))
        bezierPath.addCurve(to: CGPoint(x: 82.18, y: 116.28), controlPoint1: CGPoint(x: 80.52, y: 123.58), controlPoint2: CGPoint(x: 82.05, y: 119.86))
        bezierPath.addCurve(to: CGPoint(x: 79.4, y: 89.35), controlPoint1: CGPoint(x: 82.4, y: 110.13), controlPoint2: CGPoint(x: 70.46, y: 98.84))
        bezierPath.addLine(to: CGPoint(x: 89.11, y: 79.64))
        bezierPath.addCurve(to: CGPoint(x: 115.97, y: 82.33), controlPoint1: CGPoint(x: 98.72, y: 70.18), controlPoint2: CGPoint(x: 109.84, y: 82.57))
        bezierPath.addCurve(to: CGPoint(x: 125.87, y: 78.2), controlPoint1: CGPoint(x: 119.54, y: 82.19), controlPoint2: CGPoint(x: 123.26, y: 80.64))
        bezierPath.addCurve(to: CGPoint(x: 142.97, y: 57.19), controlPoint1: CGPoint(x: 130.37, y: 74.01), controlPoint2: CGPoint(x: 129.43, y: 57.3))
        bezierPath.addLine(to: CGPoint(x: 156.7, y: 57.19))
        bezierPath.addCurve(to: CGPoint(x: 173.77, y: 78.08), controlPoint1: CGPoint(x: 169.68, y: 57.58), controlPoint2: CGPoint(x: 169.27, y: 73.92))
        bezierPath.addCurve(to: CGPoint(x: 183.71, y: 82.17), controlPoint1: CGPoint(x: 176.4, y: 80.51), controlPoint2: CGPoint(x: 180.13, y: 82.05))
        bezierPath.addCurve(to: CGPoint(x: 210.65, y: 79.4), controlPoint1: CGPoint(x: 189.85, y: 82.39), controlPoint2: CGPoint(x: 201, y: 69.9))
        bezierPath.addLine(to: CGPoint(x: 220.36, y: 89.11))
        bezierPath.addCurve(to: CGPoint(x: 217.66, y: 115.95), controlPoint1: CGPoint(x: 229.27, y: 98.57), controlPoint2: CGPoint(x: 217.42, y: 109.83))
        bezierPath.addCurve(to: CGPoint(x: 221.8, y: 125.87), controlPoint1: CGPoint(x: 217.8, y: 119.53), controlPoint2: CGPoint(x: 219.35, y: 123.25))
        bezierPath.addCurve(to: CGPoint(x: 242.81, y: 142.97), controlPoint1: CGPoint(x: 225.99, y: 130.38), controlPoint2: CGPoint(x: 242.7, y: 129.43))
        bezierPath.addLine(to: CGPoint(x: 242.81, y: 156.7))
        bezierPath.addCurve(to: CGPoint(x: 221.92, y: 173.77), controlPoint1: CGPoint(x: 242.42, y: 169.68), controlPoint2: CGPoint(x: 226.08, y: 169.27))
        bezierPath.addCurve(to: CGPoint(x: 217.83, y: 183.71), controlPoint1: CGPoint(x: 219.49, y: 176.4), controlPoint2: CGPoint(x: 217.95, y: 180.13))
        bezierPath.addCurve(to: CGPoint(x: 220.6, y: 210.65), controlPoint1: CGPoint(x: 217.61, y: 189.85), controlPoint2: CGPoint(x: 230.1, y: 201))
        bezierPath.addLine(to: CGPoint(x: 210.89, y: 220.36))
        bezierPath.addCurve(to: CGPoint(x: 184.05, y: 217.66), controlPoint1: CGPoint(x: 201.43, y: 229.27), controlPoint2: CGPoint(x: 190.18, y: 217.42))
        bezierPath.addCurve(to: CGPoint(x: 174.11, y: 221.8), controlPoint1: CGPoint(x: 180.46, y: 217.8), controlPoint2: CGPoint(x: 176.74, y: 219.36))
        bezierPath.addCurve(to: CGPoint(x: 157.03, y: 242.81), controlPoint1: CGPoint(x: 169.61, y: 225.99), controlPoint2: CGPoint(x: 170.07, y: 242.41))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 195.65, y: 110.77))
        bezierPath.addLine(to: CGPoint(x: 183.78, y: 122.64))
        bezierPath.addCurve(to: CGPoint(x: 194.11, y: 150.71), controlPoint1: CGPoint(x: 190.22, y: 130.2), controlPoint2: CGPoint(x: 194.11, y: 140.01))
        bezierPath.addCurve(to: CGPoint(x: 150.78, y: 194.04), controlPoint1: CGPoint(x: 194.11, y: 174.63), controlPoint2: CGPoint(x: 174.7, y: 194.04))
        bezierPath.addCurve(to: CGPoint(x: 122.71, y: 183.71), controlPoint1: CGPoint(x: 140.08, y: 194.04), controlPoint2: CGPoint(x: 130.27, y: 190.15))
        bezierPath.addLine(to: CGPoint(x: 110.06, y: 196.36))
        bezierPath.addCurve(to: CGPoint(x: 150, y: 211.37), controlPoint1: CGPoint(x: 120.73, y: 205.71), controlPoint2: CGPoint(x: 134.71, y: 211.37))
        bezierPath.addCurve(to: CGPoint(x: 210.66, y: 150.71), controlPoint1: CGPoint(x: 183.48, y: 211.37), controlPoint2: CGPoint(x: 210.66, y: 184.19))
        bezierPath.addCurve(to: CGPoint(x: 195.65, y: 110.77), controlPoint1: CGPoint(x: 210.66, y: 135.42), controlPoint2: CGPoint(x: 204.99, y: 121.45))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 189.17, y: 104.41))
        bezierPath.addCurve(to: CGPoint(x: 150, y: 90.05), controlPoint1: CGPoint(x: 178.6, y: 95.45), controlPoint2: CGPoint(x: 164.93, y: 90.05))
        bezierPath.addCurve(to: CGPoint(x: 89.34, y: 150.71), controlPoint1: CGPoint(x: 116.52, y: 90.05), controlPoint2: CGPoint(x: 89.34, y: 117.23))
        bezierPath.addCurve(to: CGPoint(x: 103.7, y: 189.89), controlPoint1: CGPoint(x: 89.34, y: 165.64), controlPoint2: CGPoint(x: 94.74, y: 179.31))
        bezierPath.addLine(to: CGPoint(x: 116.45, y: 177.13))
        bezierPath.addCurve(to: CGPoint(x: 107.45, y: 150.71), controlPoint1: CGPoint(x: 110.81, y: 169.82), controlPoint2: CGPoint(x: 107.45, y: 160.65))
        bezierPath.addCurve(to: CGPoint(x: 150.78, y: 107.38), controlPoint1: CGPoint(x: 107.45, y: 126.8), controlPoint2: CGPoint(x: 126.87, y: 107.38))
        bezierPath.addCurve(to: CGPoint(x: 177.2, y: 116.38), controlPoint1: CGPoint(x: 160.72, y: 107.38), controlPoint2: CGPoint(x: 169.89, y: 110.74))
        bezierPath.addLine(to: CGPoint(x: 189.17, y: 104.41))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 150.78, y: 117.49))
        bezierPath.addCurve(to: CGPoint(x: 184, y: 150.71), controlPoint1: CGPoint(x: 169.12, y: 117.49), controlPoint2: CGPoint(x: 184, y: 132.38))
        bezierPath.addCurve(to: CGPoint(x: 150.78, y: 183.93), controlPoint1: CGPoint(x: 184, y: 169.05), controlPoint2: CGPoint(x: 169.12, y: 183.93))
        bezierPath.addCurve(to: CGPoint(x: 117.56, y: 150.71), controlPoint1: CGPoint(x: 132.45, y: 183.93), controlPoint2: CGPoint(x: 117.56, y: 169.05))
        bezierPath.addCurve(to: CGPoint(x: 150.78, y: 117.49), controlPoint1: CGPoint(x: 117.56, y: 132.38), controlPoint2: CGPoint(x: 132.45, y: 117.49))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        iconColor.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawArtistsIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// artists Drawing
        let artistsPath = UIBezierPath()
        artistsPath.move(to: CGPoint(x: 62.28, y: 195.96))
        artistsPath.addCurve(to: CGPoint(x: 91.8, y: 179.19), controlPoint1: CGPoint(x: 68.38, y: 184.3), controlPoint2: CGPoint(x: 82.06, y: 182.7))
        artistsPath.addCurve(to: CGPoint(x: 89.14, y: 164.2), controlPoint1: CGPoint(x: 96.46, y: 177.52), controlPoint2: CGPoint(x: 92.25, y: 170.01))
        artistsPath.addCurve(to: CGPoint(x: 77.54, y: 148.94), controlPoint1: CGPoint(x: 84.72, y: 155.95), controlPoint2: CGPoint(x: 77.54, y: 148.94))
        artistsPath.addCurve(to: CGPoint(x: 62.51, y: 133.08), controlPoint1: CGPoint(x: 77.54, y: 148.94), controlPoint2: CGPoint(x: 68.42, y: 140.84))
        artistsPath.addCurve(to: CGPoint(x: 67.35, y: 122.04), controlPoint1: CGPoint(x: 59.39, y: 128.99), controlPoint2: CGPoint(x: 62.98, y: 122.86))
        artistsPath.addCurve(to: CGPoint(x: 108.75, y: 114.14), controlPoint1: CGPoint(x: 80.64, y: 119.54), controlPoint2: CGPoint(x: 101.71, y: 114.84))
        artistsPath.addCurve(to: CGPoint(x: 113.8, y: 117.09), controlPoint1: CGPoint(x: 110.69, y: 113.95), controlPoint2: CGPoint(x: 113.09, y: 115.27))
        artistsPath.addCurve(to: CGPoint(x: 120.04, y: 133.71), controlPoint1: CGPoint(x: 115.31, y: 121), controlPoint2: CGPoint(x: 119.73, y: 129.82))
        artistsPath.addCurve(to: CGPoint(x: 116.25, y: 138.7), controlPoint1: CGPoint(x: 120.21, y: 135.79), controlPoint2: CGPoint(x: 118.24, y: 138.04))
        artistsPath.addCurve(to: CGPoint(x: 84.19, y: 143.72), controlPoint1: CGPoint(x: 111.12, y: 140.38), controlPoint2: CGPoint(x: 84.19, y: 143.72))
        artistsPath.addCurve(to: CGPoint(x: 96.23, y: 159.73), controlPoint1: CGPoint(x: 84.19, y: 143.72), controlPoint2: CGPoint(x: 94.46, y: 156.47))
        artistsPath.addCurve(to: CGPoint(x: 102.26, y: 169.53), controlPoint1: CGPoint(x: 96.23, y: 159.73), controlPoint2: CGPoint(x: 99.43, y: 164.35))
        artistsPath.addCurve(to: CGPoint(x: 108.58, y: 183.37), controlPoint1: CGPoint(x: 105.2, y: 174.95), controlPoint2: CGPoint(x: 107.77, y: 181))
        artistsPath.addCurve(to: CGPoint(x: 109.39, y: 223.16), controlPoint1: CGPoint(x: 111.19, y: 190.96), controlPoint2: CGPoint(x: 117.39, y: 209.11))
        artistsPath.addCurve(to: CGPoint(x: 72.24, y: 233.12), controlPoint1: CGPoint(x: 101.97, y: 236.21), controlPoint2: CGPoint(x: 85.24, y: 240.62))
        artistsPath.addCurve(to: CGPoint(x: 62.28, y: 195.96), controlPoint1: CGPoint(x: 59.24, y: 225.61), controlPoint2: CGPoint(x: 55.33, y: 209.27))
        artistsPath.close()
        artistsPath.move(to: CGPoint(x: 210.99, y: 232.2))
        artistsPath.addLine(to: CGPoint(x: 121.01, y: 232.2))
        artistsPath.addCurve(to: CGPoint(x: 116.89, y: 169.03), controlPoint1: CGPoint(x: 127.38, y: 215.99), controlPoint2: CGPoint(x: 126.4, y: 192.42))
        artistsPath.addCurve(to: CGPoint(x: 109.27, y: 153.65), controlPoint1: CGPoint(x: 114.66, y: 163.56), controlPoint2: CGPoint(x: 109.27, y: 153.65))
        artistsPath.addCurve(to: CGPoint(x: 122.56, y: 151.8), controlPoint1: CGPoint(x: 109.27, y: 153.65), controlPoint2: CGPoint(x: 113.89, y: 152.13))
        artistsPath.addCurve(to: CGPoint(x: 194.91, y: 151.8), controlPoint1: CGPoint(x: 136.83, y: 151.49), controlPoint2: CGPoint(x: 194.91, y: 151.8))
        artistsPath.addCurve(to: CGPoint(x: 239.13, y: 192), controlPoint1: CGPoint(x: 219.32, y: 151.8), controlPoint2: CGPoint(x: 239.13, y: 169.81))
        artistsPath.addCurve(to: CGPoint(x: 210.99, y: 232.2), controlPoint1: CGPoint(x: 239.13, y: 214.19), controlPoint2: CGPoint(x: 235.4, y: 232.2))
        artistsPath.close()
        artistsPath.move(to: CGPoint(x: 158.73, y: 63.36))
        artistsPath.addCurve(to: CGPoint(x: 196.92, y: 101.55), controlPoint1: CGPoint(x: 179.82, y: 63.36), controlPoint2: CGPoint(x: 196.92, y: 80.47))
        artistsPath.addCurve(to: CGPoint(x: 158.73, y: 139.74), controlPoint1: CGPoint(x: 196.92, y: 122.63), controlPoint2: CGPoint(x: 179.82, y: 139.74))
        artistsPath.addCurve(to: CGPoint(x: 120.55, y: 101.55), controlPoint1: CGPoint(x: 137.65, y: 139.74), controlPoint2: CGPoint(x: 120.55, y: 122.63))
        artistsPath.addCurve(to: CGPoint(x: 158.73, y: 63.36), controlPoint1: CGPoint(x: 120.55, y: 80.47), controlPoint2: CGPoint(x: 137.65, y: 63.36))
        artistsPath.close()
        artistsPath.usesEvenOddFillRule = true
        iconColor.setFill()
        artistsPath.fill()
    ...
    @objc dynamic public class func drawPlaceholderArtistArtwork(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// artists Drawing
        let artistsPath = UIBezierPath()
        artistsPath.move(to: CGPoint(x: 82.51, y: 186.06))
        artistsPath.addCurve(to: CGPoint(x: 105.4, y: 173.05), controlPoint1: CGPoint(x: 87.24, y: 177.02), controlPoint2: CGPoint(x: 97.85, y: 175.77))
        artistsPath.addCurve(to: CGPoint(x: 103.34, y: 161.43), controlPoint1: CGPoint(x: 109.01, y: 171.75), controlPoint2: CGPoint(x: 105.75, y: 165.93))
        artistsPath.addCurve(to: CGPoint(x: 94.34, y: 149.59), controlPoint1: CGPoint(x: 99.91, y: 155.03), controlPoint2: CGPoint(x: 94.34, y: 149.59))
        artistsPath.addCurve(to: CGPoint(x: 82.68, y: 137.29), controlPoint1: CGPoint(x: 94.34, y: 149.59), controlPoint2: CGPoint(x: 87.27, y: 143.31))
        artistsPath.addCurve(to: CGPoint(x: 86.44, y: 128.73), controlPoint1: CGPoint(x: 80.27, y: 134.12), controlPoint2: CGPoint(x: 83.05, y: 129.36))
        artistsPath.addCurve(to: CGPoint(x: 118.55, y: 122.6), controlPoint1: CGPoint(x: 96.74, y: 126.79), controlPoint2: CGPoint(x: 113.09, y: 123.15))
        artistsPath.addCurve(to: CGPoint(x: 122.46, y: 124.89), controlPoint1: CGPoint(x: 120.05, y: 122.45), controlPoint2: CGPoint(x: 121.91, y: 123.48))
        artistsPath.addCurve(to: CGPoint(x: 127.3, y: 137.78), controlPoint1: CGPoint(x: 123.63, y: 127.92), controlPoint2: CGPoint(x: 127.06, y: 134.76))
        artistsPath.addCurve(to: CGPoint(x: 124.36, y: 141.65), controlPoint1: CGPoint(x: 127.43, y: 139.39), controlPoint2: CGPoint(x: 125.9, y: 141.14))
        artistsPath.addCurve(to: CGPoint(x: 99.5, y: 145.54), controlPoint1: CGPoint(x: 120.39, y: 142.95), controlPoint2: CGPoint(x: 99.5, y: 145.54))
        artistsPath.addCurve(to: CGPoint(x: 108.83, y: 157.96), controlPoint1: CGPoint(x: 99.5, y: 145.54), controlPoint2: CGPoint(x: 107.47, y: 155.43))
        artistsPath.addCurve(to: CGPoint(x: 113.51, y: 165.56), controlPoint1: CGPoint(x: 108.83, y: 157.96), controlPoint2: CGPoint(x: 111.32, y: 161.54))
        artistsPath.addCurve(to: CGPoint(x: 118.42, y: 176.29), controlPoint1: CGPoint(x: 115.79, y: 169.76), controlPoint2: CGPoint(x: 117.79, y: 174.45))
        artistsPath.addCurve(to: CGPoint(x: 119.05, y: 207.15), controlPoint1: CGPoint(x: 120.44, y: 182.18), controlPoint2: CGPoint(x: 125.25, y: 196.25))
        artistsPath.addCurve(to: CGPoint(x: 90.23, y: 214.87), controlPoint1: CGPoint(x: 113.29, y: 217.27), controlPoint2: CGPoint(x: 100.32, y: 220.69))
        artistsPath.addCurve(to: CGPoint(x: 82.51, y: 186.06), controlPoint1: CGPoint(x: 80.15, y: 209.05), controlPoint2: CGPoint(x: 77.12, y: 196.38))
        artistsPath.close()
        artistsPath.move(to: CGPoint(x: 197.84, y: 214.16))
        artistsPath.addLine(to: CGPoint(x: 128.06, y: 214.16))
        artistsPath.addCurve(to: CGPoint(x: 124.86, y: 165.17), controlPoint1: CGPoint(x: 132.99, y: 201.59), controlPoint2: CGPoint(x: 132.23, y: 183.31))
        artistsPath.addCurve(to: CGPoint(x: 118.95, y: 153.24), controlPoint1: CGPoint(x: 123.13, y: 160.93), controlPoint2: CGPoint(x: 118.95, y: 153.24))
        artistsPath.addCurve(to: CGPoint(x: 129.25, y: 151.81), controlPoint1: CGPoint(x: 118.95, y: 153.24), controlPoint2: CGPoint(x: 122.53, y: 152.06))
        artistsPath.addCurve(to: CGPoint(x: 185.37, y: 151.81), controlPoint1: CGPoint(x: 140.32, y: 151.57), controlPoint2: CGPoint(x: 185.37, y: 151.81))
        artistsPath.addCurve(to: CGPoint(x: 219.66, y: 182.98), controlPoint1: CGPoint(x: 204.3, y: 151.81), controlPoint2: CGPoint(x: 219.66, y: 165.77))
        artistsPath.addCurve(to: CGPoint(x: 197.84, y: 214.16), controlPoint1: CGPoint(x: 219.66, y: 200.19), controlPoint2: CGPoint(x: 216.77, y: 214.16))
        artistsPath.close()
        artistsPath.move(to: CGPoint(x: 157.31, y: 83.22))
        artistsPath.addCurve(to: CGPoint(x: 186.93, y: 112.84), controlPoint1: CGPoint(x: 173.66, y: 83.22), controlPoint2: CGPoint(x: 186.93, y: 96.49))
        artistsPath.addCurve(to: CGPoint(x: 157.31, y: 142.46), controlPoint1: CGPoint(x: 186.93, y: 129.19), controlPoint2: CGPoint(x: 173.66, y: 142.46))
        artistsPath.addCurve(to: CGPoint(x: 127.69, y: 112.84), controlPoint1: CGPoint(x: 140.96, y: 142.46), controlPoint2: CGPoint(x: 127.69, y: 129.19))
        artistsPath.addCurve(to: CGPoint(x: 157.31, y: 83.22), controlPoint1: CGPoint(x: 127.69, y: 96.49), controlPoint2: CGPoint(x: 140.96, y: 83.22))
        artistsPath.close()
        artistsPath.usesEvenOddFillRule = true
        StyleKit.lightGlyphColor.setFill()
        artistsPath.fill()
    ...
    @objc dynamic public class func drawDownIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawCheckmarkIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawRightIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawUpIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawDisplayBrightnessMinIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawDisplayBrightnessMaxIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawCloseIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        bezier3Path.move(to: CGPoint(x: 202.52, y: 86.25))
        bezier3Path.addCurve(to: CGPoint(x: 207.84, y: 90.75), controlPoint1: CGPoint(x: 204.23, y: 87.14), controlPoint2: CGPoint(x: 205.43, y: 88.34))
        bezier3Path.addLine(to: CGPoint(x: 210.27, y: 93.18))
        bezier3Path.addCurve(to: CGPoint(x: 214.61, y: 98.23), controlPoint1: CGPoint(x: 212.67, y: 95.58), controlPoint2: CGPoint(x: 213.88, y: 96.79))
        bezier3Path.addLine(to: CGPoint(x: 214.77, y: 98.5))
        bezier3Path.addCurve(to: CGPoint(x: 214.77, y: 104.59), controlPoint1: CGPoint(x: 215.67, y: 100.43), controlPoint2: CGPoint(x: 215.67, y: 102.66))
        bezier3Path.addCurve(to: CGPoint(x: 210.27, y: 109.91), controlPoint1: CGPoint(x: 213.88, y: 106.29), controlPoint2: CGPoint(x: 212.67, y: 107.5))
        bezier3Path.addLine(to: CGPoint(x: 172.11, y: 148.06))
        bezier3Path.addCurve(to: CGPoint(x: 210.27, y: 186.22), controlPoint1: CGPoint(x: 186.52, y: 162.47), controlPoint2: CGPoint(x: 210.27, y: 186.22))
        bezier3Path.addCurve(to: CGPoint(x: 214.61, y: 191.27), controlPoint1: CGPoint(x: 212.67, y: 188.62), controlPoint2: CGPoint(x: 213.88, y: 189.83))
        bezier3Path.addLine(to: CGPoint(x: 214.77, y: 191.54))
        bezier3Path.addCurve(to: CGPoint(x: 214.77, y: 197.63), controlPoint1: CGPoint(x: 215.67, y: 193.47), controlPoint2: CGPoint(x: 215.67, y: 195.7))
        bezier3Path.addCurve(to: CGPoint(x: 210.27, y: 202.95), controlPoint1: CGPoint(x: 213.88, y: 199.33), controlPoint2: CGPoint(x: 212.67, y: 200.54))
        bezier3Path.addLine(to: CGPoint(x: 207.84, y: 205.37))
        bezier3Path.addCurve(to: CGPoint(x: 202.78, y: 209.71), controlPoint1: CGPoint(x: 205.43, y: 207.78), controlPoint2: CGPoint(x: 204.23, y: 208.98))
        bezier3Path.addLine(to: CGPoint(x: 202.52, y: 209.87))
        bezier3Path.addCurve(to: CGPoint(x: 196.43, y: 209.87), controlPoint1: CGPoint(x: 200.59, y: 210.77), controlPoint2: CGPoint(x: 198.36, y: 210.77))
        bezier3Path.addCurve(to: CGPoint(x: 191.11, y: 205.37), controlPoint1: CGPoint(x: 194.72, y: 208.98), controlPoint2: CGPoint(x: 193.52, y: 207.78))
        bezier3Path.addCurve(to: CGPoint(x: 152.5, y: 166.76), controlPoint1: CGPoint(x: 191.11, y: 205.37), controlPoint2: CGPoint(x: 166.86, y: 181.12))
        bezier3Path.addCurve(to: CGPoint(x: 113.88, y: 205.37), controlPoint1: CGPoint(x: 138.14, y: 181.12), controlPoint2: CGPoint(x: 113.88, y: 205.37))
        bezier3Path.addCurve(to: CGPoint(x: 108.82, y: 209.71), controlPoint1: CGPoint(x: 111.47, y: 207.78), controlPoint2: CGPoint(x: 110.27, y: 208.98))
        bezier3Path.addLine(to: CGPoint(x: 108.56, y: 209.87))
        bezier3Path.addCurve(to: CGPoint(x: 102.47, y: 209.87), controlPoint1: CGPoint(x: 106.63, y: 210.77), controlPoint2: CGPoint(x: 104.4, y: 210.77))
        bezier3Path.addCurve(to: CGPoint(x: 97.15, y: 205.37), controlPoint1: CGPoint(x: 100.76, y: 208.98), controlPoint2: CGPoint(x: 99.56, y: 207.78))
        bezier3Path.addLine(to: CGPoint(x: 94.73, y: 202.95))
        bezier3Path.addCurve(to: CGPoint(x: 90.39, y: 197.89), controlPoint1: CGPoint(x: 92.32, y: 200.54), controlPoint2: CGPoint(x: 91.11, y: 199.33))
        bezier3Path.addLine(to: CGPoint(x: 90.23, y: 197.63))
        bezier3Path.addCurve(to: CGPoint(x: 90.23, y: 191.54), controlPoint1: CGPoint(x: 89.33, y: 195.7), controlPoint2: CGPoint(x: 89.33, y: 193.47))
        bezier3Path.addCurve(to: CGPoint(x: 94.73, y: 186.22), controlPoint1: CGPoint(x: 91.11, y: 189.83), controlPoint2: CGPoint(x: 92.32, y: 188.62))
        bezier3Path.addLine(to: CGPoint(x: 132.88, y: 148.06))
        bezier3Path.addCurve(to: CGPoint(x: 94.73, y: 109.91), controlPoint1: CGPoint(x: 118.47, y: 133.65), controlPoint2: CGPoint(x: 94.73, y: 109.91))
        bezier3Path.addCurve(to: CGPoint(x: 90.39, y: 104.85), controlPoint1: CGPoint(x: 92.32, y: 107.5), controlPoint2: CGPoint(x: 91.11, y: 106.29))
        bezier3Path.addLine(to: CGPoint(x: 90.23, y: 104.59))
        bezier3Path.addCurve(to: CGPoint(x: 90.23, y: 98.5), controlPoint1: CGPoint(x: 89.33, y: 102.66), controlPoint2: CGPoint(x: 89.33, y: 100.43))
        bezier3Path.addCurve(to: CGPoint(x: 94.73, y: 93.18), controlPoint1: CGPoint(x: 91.11, y: 96.79), controlPoint2: CGPoint(x: 92.32, y: 95.58))
        bezier3Path.addLine(to: CGPoint(x: 97.15, y: 90.75))
        bezier3Path.addCurve(to: CGPoint(x: 102.21, y: 86.41), controlPoint1: CGPoint(x: 99.56, y: 88.34), controlPoint2: CGPoint(x: 100.76, y: 87.14))
        bezier3Path.addLine(to: CGPoint(x: 102.47, y: 86.25))
        bezier3Path.addCurve(to: CGPoint(x: 108.56, y: 86.25), controlPoint1: CGPoint(x: 104.4, y: 85.35), controlPoint2: CGPoint(x: 106.63, y: 85.35))
        bezier3Path.addCurve(to: CGPoint(x: 113.88, y: 90.75), controlPoint1: CGPoint(x: 110.27, y: 87.14), controlPoint2: CGPoint(x: 111.47, y: 88.34))
        bezier3Path.addCurve(to: CGPoint(x: 152.5, y: 129.37), controlPoint1: CGPoint(x: 113.88, y: 90.75), controlPoint2: CGPoint(x: 138.14, y: 115.01))
        bezier3Path.addCurve(to: CGPoint(x: 191.11, y: 90.75), controlPoint1: CGPoint(x: 166.86, y: 115.01), controlPoint2: CGPoint(x: 191.11, y: 90.75))
        bezier3Path.addCurve(to: CGPoint(x: 196.17, y: 86.41), controlPoint1: CGPoint(x: 193.52, y: 88.34), controlPoint2: CGPoint(x: 194.72, y: 87.14))
        bezier3Path.addLine(to: CGPoint(x: 196.43, y: 86.25))
        bezier3Path.addCurve(to: CGPoint(x: 202.52, y: 86.25), controlPoint1: CGPoint(x: 198.36, y: 85.35), controlPoint2: CGPoint(x: 200.59, y: 85.35))
        bezier3Path.close()
        iconColor.setFill()
        bezier3Path.fill()
    ...
    @objc dynamic public class func drawSortIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawMoreIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawReleasesIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 190.93, y: 231.27))
        bezierPath.addLine(to: CGPoint(x: 85.47, y: 231.27))
        bezierPath.addCurve(to: CGPoint(x: 57.19, y: 202.98), controlPoint1: CGPoint(x: 69.86, y: 231.27), controlPoint2: CGPoint(x: 57.19, y: 218.59))
        bezierPath.addLine(to: CGPoint(x: 57.19, y: 97.48))
        bezierPath.addCurve(to: CGPoint(x: 79.11, y: 69.91), controlPoint1: CGPoint(x: 57.19, y: 84.05), controlPoint2: CGPoint(x: 66.56, y: 72.8))
        bezierPath.addCurve(to: CGPoint(x: 107.11, y: 82.02), controlPoint1: CGPoint(x: 84.34, y: 71.45), controlPoint2: CGPoint(x: 96.62, y: 75.49))
        bezierPath.addCurve(to: CGPoint(x: 124.08, y: 102.17), controlPoint1: CGPoint(x: 116.79, y: 88.03), controlPoint2: CGPoint(x: 129.59, y: 95.65))
        bezierPath.addCurve(to: CGPoint(x: 94.35, y: 152.85), controlPoint1: CGPoint(x: 112.5, y: 115.86), controlPoint2: CGPoint(x: 93.4, y: 130.11))
        bezierPath.addCurve(to: CGPoint(x: 141.41, y: 199.92), controlPoint1: CGPoint(x: 95.45, y: 178.81), controlPoint2: CGPoint(x: 115.44, y: 199.92))
        bezierPath.addCurve(to: CGPoint(x: 188.46, y: 152.85), controlPoint1: CGPoint(x: 167.38, y: 199.92), controlPoint2: CGPoint(x: 188.63, y: 178.83))
        bezierPath.addCurve(to: CGPoint(x: 152.83, y: 93.92), controlPoint1: CGPoint(x: 188.28, y: 124.87), controlPoint2: CGPoint(x: 163.29, y: 103.04))
        bezierPath.addCurve(to: CGPoint(x: 131.37, y: 78.67), controlPoint1: CGPoint(x: 149.55, y: 91.07), controlPoint2: CGPoint(x: 140.47, y: 84.24))
        bezierPath.addCurve(to: CGPoint(x: 113.88, y: 69.19), controlPoint1: CGPoint(x: 122.67, y: 73.34), controlPoint2: CGPoint(x: 113.88, y: 69.19))
        bezierPath.addLine(to: CGPoint(x: 85.47, y: 69.19))
        bezierPath.addLine(to: CGPoint(x: 190.93, y: 69.19))
        bezierPath.addCurve(to: CGPoint(x: 219.21, y: 97.48), controlPoint1: CGPoint(x: 206.54, y: 69.19), controlPoint2: CGPoint(x: 219.21, y: 81.87))
        bezierPath.addLine(to: CGPoint(x: 219.21, y: 202.98))
        bezierPath.addCurve(to: CGPoint(x: 190.93, y: 231.27), controlPoint1: CGPoint(x: 219.21, y: 218.59), controlPoint2: CGPoint(x: 206.54, y: 231.27))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 221.59, y: 80.99))
        bezierPath.addCurve(to: CGPoint(x: 242.27, y: 104.99), controlPoint1: CGPoint(x: 233.28, y: 82.72), controlPoint2: CGPoint(x: 242.27, y: 92.81))
        bezierPath.addLine(to: CGPoint(x: 242.27, y: 195.47))
        bezierPath.addCurve(to: CGPoint(x: 221.59, y: 219.47), controlPoint1: CGPoint(x: 242.27, y: 207.65), controlPoint2: CGPoint(x: 233.28, y: 217.74))
        bezierPath.addCurve(to: CGPoint(x: 226.89, y: 202.98), controlPoint1: CGPoint(x: 224.93, y: 214.83), controlPoint2: CGPoint(x: 226.89, y: 209.14))
        bezierPath.addLine(to: CGPoint(x: 226.89, y: 97.48))
        bezierPath.addCurve(to: CGPoint(x: 221.59, y: 80.99), controlPoint1: CGPoint(x: 226.89, y: 91.32), controlPoint2: CGPoint(x: 224.93, y: 85.63))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        iconColor.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawShareIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 201.8, y: 132.82))
        bezier3Path.addLine(to: CGPoint(x: 202.04, y: 132.88))
        bezier3Path.addCurve(to: CGPoint(x: 205.51, y: 136.36), controlPoint1: CGPoint(x: 203.65, y: 133.47), controlPoint2: CGPoint(x: 204.92, y: 134.74))
        bezier3Path.addCurve(to: CGPoint(x: 205.98, y: 141.96), controlPoint1: CGPoint(x: 205.98, y: 137.84), controlPoint2: CGPoint(x: 205.98, y: 139.21))
        bezier3Path.addLine(to: CGPoint(x: 205.98, y: 211.41))
        bezier3Path.addCurve(to: CGPoint(x: 205.57, y: 216.77), controlPoint1: CGPoint(x: 205.98, y: 214.16), controlPoint2: CGPoint(x: 205.98, y: 215.53))
        bezier3Path.addLine(to: CGPoint(x: 205.51, y: 217.01))
        bezier3Path.addCurve(to: CGPoint(x: 202.04, y: 220.49), controlPoint1: CGPoint(x: 204.92, y: 218.63), controlPoint2: CGPoint(x: 203.65, y: 219.9))
        bezier3Path.addCurve(to: CGPoint(x: 196.43, y: 220.96), controlPoint1: CGPoint(x: 200.56, y: 220.96), controlPoint2: CGPoint(x: 199.18, y: 220.96))
        bezier3Path.addLine(to: CGPoint(x: 103.57, y: 220.96))
        bezier3Path.addCurve(to: CGPoint(x: 98.2, y: 220.55), controlPoint1: CGPoint(x: 100.82, y: 220.96), controlPoint2: CGPoint(x: 99.44, y: 220.96))
        bezier3Path.addLine(to: CGPoint(x: 97.96, y: 220.49))
        bezier3Path.addCurve(to: CGPoint(x: 94.49, y: 217.01), controlPoint1: CGPoint(x: 96.35, y: 219.9), controlPoint2: CGPoint(x: 95.08, y: 218.63))
        bezier3Path.addCurve(to: CGPoint(x: 94.02, y: 211.41), controlPoint1: CGPoint(x: 94.02, y: 215.53), controlPoint2: CGPoint(x: 94.02, y: 214.16))
        bezier3Path.addLine(to: CGPoint(x: 94.02, y: 141.96))
        bezier3Path.addCurve(to: CGPoint(x: 94.43, y: 136.6), controlPoint1: CGPoint(x: 94.02, y: 139.21), controlPoint2: CGPoint(x: 94.02, y: 137.84))
        bezier3Path.addLine(to: CGPoint(x: 94.49, y: 136.36))
        bezier3Path.addCurve(to: CGPoint(x: 97.96, y: 132.88), controlPoint1: CGPoint(x: 95.08, y: 134.74), controlPoint2: CGPoint(x: 96.35, y: 133.47))
        bezier3Path.addCurve(to: CGPoint(x: 99.15, y: 132.6), controlPoint1: CGPoint(x: 98.36, y: 132.76), controlPoint2: CGPoint(x: 98.74, y: 132.67))
        bezier3Path.addCurve(to: CGPoint(x: 103.57, y: 132.42), controlPoint1: CGPoint(x: 100.27, y: 132.42), controlPoint2: CGPoint(x: 101.55, y: 132.42))
        bezier3Path.addLine(to: CGPoint(x: 128.92, y: 132.42))
        bezier3Path.addCurve(to: CGPoint(x: 128.92, y: 142.89), controlPoint1: CGPoint(x: 128.92, y: 135.71), controlPoint2: CGPoint(x: 128.92, y: 139.26))
        bezier3Path.addLine(to: CGPoint(x: 108.1, y: 142.89))
        bezier3Path.addCurve(to: CGPoint(x: 106, y: 143.07), controlPoint1: CGPoint(x: 107.07, y: 142.89), controlPoint2: CGPoint(x: 106.56, y: 142.89))
        bezier3Path.addCurve(to: CGPoint(x: 104.7, y: 144.37), controlPoint1: CGPoint(x: 105.4, y: 143.29), controlPoint2: CGPoint(x: 104.92, y: 143.77))
        bezier3Path.addLine(to: CGPoint(x: 104.68, y: 144.46))
        bezier3Path.addCurve(to: CGPoint(x: 104.52, y: 146.47), controlPoint1: CGPoint(x: 104.52, y: 144.93), controlPoint2: CGPoint(x: 104.52, y: 145.44))
        bezier3Path.addLine(to: CGPoint(x: 104.52, y: 207.24))
        bezier3Path.addCurve(to: CGPoint(x: 104.7, y: 209.34), controlPoint1: CGPoint(x: 104.52, y: 208.27), controlPoint2: CGPoint(x: 104.52, y: 208.79))
        bezier3Path.addCurve(to: CGPoint(x: 106, y: 210.64), controlPoint1: CGPoint(x: 104.92, y: 209.95), controlPoint2: CGPoint(x: 105.4, y: 210.42))
        bezier3Path.addLine(to: CGPoint(x: 106.09, y: 210.67))
        bezier3Path.addCurve(to: CGPoint(x: 108.1, y: 210.82), controlPoint1: CGPoint(x: 106.56, y: 210.82), controlPoint2: CGPoint(x: 107.07, y: 210.82))
        bezier3Path.addLine(to: CGPoint(x: 191.9, y: 210.82))
        bezier3Path.addCurve(to: CGPoint(x: 194, y: 210.64), controlPoint1: CGPoint(x: 192.93, y: 210.82), controlPoint2: CGPoint(x: 193.44, y: 210.82))
        bezier3Path.addCurve(to: CGPoint(x: 195.3, y: 209.34), controlPoint1: CGPoint(x: 194.6, y: 210.42), controlPoint2: CGPoint(x: 195.08, y: 209.95))
        bezier3Path.addLine(to: CGPoint(x: 195.32, y: 209.25))
        bezier3Path.addCurve(to: CGPoint(x: 195.48, y: 207.24), controlPoint1: CGPoint(x: 195.48, y: 208.79), controlPoint2: CGPoint(x: 195.48, y: 208.27))
        bezier3Path.addLine(to: CGPoint(x: 195.48, y: 146.47))
        bezier3Path.addCurve(to: CGPoint(x: 195.3, y: 144.37), controlPoint1: CGPoint(x: 195.48, y: 145.44), controlPoint2: CGPoint(x: 195.48, y: 144.93))
        bezier3Path.addCurve(to: CGPoint(x: 194, y: 143.07), controlPoint1: CGPoint(x: 195.08, y: 143.77), controlPoint2: CGPoint(x: 194.6, y: 143.29))
        bezier3Path.addLine(to: CGPoint(x: 193.91, y: 143.05))
        bezier3Path.addCurve(to: CGPoint(x: 191.9, y: 142.89), controlPoint1: CGPoint(x: 193.44, y: 142.89), controlPoint2: CGPoint(x: 192.93, y: 142.89))
        bezier3Path.addLine(to: CGPoint(x: 171.08, y: 142.89))
        bezier3Path.addCurve(to: CGPoint(x: 171.08, y: 132.42), controlPoint1: CGPoint(x: 171.08, y: 139.26), controlPoint2: CGPoint(x: 171.08, y: 135.71))
        bezier3Path.addLine(to: CGPoint(x: 196.43, y: 132.42))
        bezier3Path.addCurve(to: CGPoint(x: 201.8, y: 132.82), controlPoint1: CGPoint(x: 199.18, y: 132.42), controlPoint2: CGPoint(x: 200.56, y: 132.42))
        bezier3Path.close()
        bezier3Path.move(to: CGPoint(x: 150.08, y: 79.45))
        bezier3Path.addCurve(to: CGPoint(x: 151.06, y: 79.66), controlPoint1: CGPoint(x: 150.41, y: 79.46), controlPoint2: CGPoint(x: 150.74, y: 79.53))
        bezier3Path.addLine(to: CGPoint(x: 151.14, y: 79.69))
        bezier3Path.addCurve(to: CGPoint(x: 151.3, y: 79.75), controlPoint1: CGPoint(x: 151.16, y: 79.68), controlPoint2: CGPoint(x: 151.3, y: 79.75))
        bezier3Path.addCurve(to: CGPoint(x: 152.64, y: 80.81), controlPoint1: CGPoint(x: 151.77, y: 80), controlPoint2: CGPoint(x: 152.14, y: 80.32))
        bezier3Path.addCurve(to: CGPoint(x: 153.34, y: 81.47), controlPoint1: CGPoint(x: 152.85, y: 81), controlPoint2: CGPoint(x: 153.07, y: 81.22))
        bezier3Path.addLine(to: CGPoint(x: 180.19, y: 107.31))
        bezier3Path.addCurve(to: CGPoint(x: 181.98, y: 109.32), controlPoint1: CGPoint(x: 181.18, y: 108.27), controlPoint2: CGPoint(x: 181.67, y: 108.74))
        bezier3Path.addLine(to: CGPoint(x: 182.04, y: 109.43))
        bezier3Path.addCurve(to: CGPoint(x: 182.09, y: 111.88), controlPoint1: CGPoint(x: 182.42, y: 110.2), controlPoint2: CGPoint(x: 182.44, y: 111.1))
        bezier3Path.addCurve(to: CGPoint(x: 180.32, y: 114.06), controlPoint1: CGPoint(x: 181.75, y: 112.58), controlPoint2: CGPoint(x: 181.27, y: 113.07))
        bezier3Path.addLine(to: CGPoint(x: 179.44, y: 114.97))
        bezier3Path.addCurve(to: CGPoint(x: 177.44, y: 116.76), controlPoint1: CGPoint(x: 178.49, y: 115.96), controlPoint2: CGPoint(x: 178.01, y: 116.46))
        bezier3Path.addLine(to: CGPoint(x: 177.33, y: 116.83))
        bezier3Path.addCurve(to: CGPoint(x: 174.87, y: 116.88), controlPoint1: CGPoint(x: 176.56, y: 117.21), controlPoint2: CGPoint(x: 175.66, y: 117.22))
        bezier3Path.addCurve(to: CGPoint(x: 172.69, y: 115.1), controlPoint1: CGPoint(x: 174.18, y: 116.53), controlPoint2: CGPoint(x: 173.68, y: 116.05))
        bezier3Path.addCurve(to: CGPoint(x: 155.4, y: 98.46), controlPoint1: CGPoint(x: 172.69, y: 115.1), controlPoint2: CGPoint(x: 163.12, y: 105.89))
        bezier3Path.addCurve(to: CGPoint(x: 155.4, y: 177.03), controlPoint1: CGPoint(x: 155.4, y: 120.35), controlPoint2: CGPoint(x: 155.4, y: 177.03))
        bezier3Path.addCurve(to: CGPoint(x: 155.2, y: 180.07), controlPoint1: CGPoint(x: 155.4, y: 178.58), controlPoint2: CGPoint(x: 155.4, y: 179.36))
        bezier3Path.addLine(to: CGPoint(x: 155.17, y: 180.2))
        bezier3Path.addCurve(to: CGPoint(x: 153.43, y: 182.17), controlPoint1: CGPoint(x: 154.88, y: 181.12), controlPoint2: CGPoint(x: 154.24, y: 181.84))
        bezier3Path.addCurve(to: CGPoint(x: 150.63, y: 182.44), controlPoint1: CGPoint(x: 152.69, y: 182.44), controlPoint2: CGPoint(x: 152, y: 182.44))
        bezier3Path.addLine(to: CGPoint(x: 149.37, y: 182.44))
        bezier3Path.addCurve(to: CGPoint(x: 146.69, y: 182.21), controlPoint1: CGPoint(x: 148, y: 182.44), controlPoint2: CGPoint(x: 147.31, y: 182.44))
        bezier3Path.addLine(to: CGPoint(x: 146.57, y: 182.17))
        bezier3Path.addCurve(to: CGPoint(x: 144.83, y: 180.2), controlPoint1: CGPoint(x: 145.76, y: 181.84), controlPoint2: CGPoint(x: 145.12, y: 181.12))
        bezier3Path.addCurve(to: CGPoint(x: 144.6, y: 177.03), controlPoint1: CGPoint(x: 144.6, y: 179.36), controlPoint2: CGPoint(x: 144.6, y: 178.58))
        bezier3Path.addCurve(to: CGPoint(x: 144.6, y: 98.46), controlPoint1: CGPoint(x: 144.6, y: 177.03), controlPoint2: CGPoint(x: 144.6, y: 120.35))
        bezier3Path.addCurve(to: CGPoint(x: 127.3, y: 115.1), controlPoint1: CGPoint(x: 136.88, y: 105.89), controlPoint2: CGPoint(x: 127.3, y: 115.1))
        bezier3Path.addCurve(to: CGPoint(x: 125.23, y: 116.81), controlPoint1: CGPoint(x: 126.31, y: 116.05), controlPoint2: CGPoint(x: 125.82, y: 116.53))
        bezier3Path.addLine(to: CGPoint(x: 125.12, y: 116.87))
        bezier3Path.addCurve(to: CGPoint(x: 122.67, y: 116.83), controlPoint1: CGPoint(x: 124.34, y: 117.22), controlPoint2: CGPoint(x: 123.44, y: 117.21))
        bezier3Path.addCurve(to: CGPoint(x: 120.56, y: 114.97), controlPoint1: CGPoint(x: 121.99, y: 116.46), controlPoint2: CGPoint(x: 121.51, y: 115.96))
        bezier3Path.addLine(to: CGPoint(x: 119.68, y: 114.06))
        bezier3Path.addCurve(to: CGPoint(x: 117.97, y: 111.99), controlPoint1: CGPoint(x: 118.73, y: 113.07), controlPoint2: CGPoint(x: 118.25, y: 112.58))
        bezier3Path.addLine(to: CGPoint(x: 117.91, y: 111.88))
        bezier3Path.addCurve(to: CGPoint(x: 117.95, y: 109.42), controlPoint1: CGPoint(x: 117.56, y: 111.1), controlPoint2: CGPoint(x: 117.58, y: 110.2))
        bezier3Path.addCurve(to: CGPoint(x: 119.81, y: 107.31), controlPoint1: CGPoint(x: 118.33, y: 108.74), controlPoint2: CGPoint(x: 118.82, y: 108.27))
        bezier3Path.addLine(to: CGPoint(x: 146.66, y: 81.47))
        bezier3Path.addCurve(to: CGPoint(x: 147.2, y: 80.96), controlPoint1: CGPoint(x: 146.86, y: 81.28), controlPoint2: CGPoint(x: 147.04, y: 81.11))
        bezier3Path.addCurve(to: CGPoint(x: 147.35, y: 80.82), controlPoint1: CGPoint(x: 147.25, y: 80.91), controlPoint2: CGPoint(x: 147.3, y: 80.86))
        bezier3Path.addCurve(to: CGPoint(x: 148.59, y: 79.81), controlPoint1: CGPoint(x: 147.84, y: 80.33), controlPoint2: CGPoint(x: 148.19, y: 80.02))
        bezier3Path.addLine(to: CGPoint(x: 148.7, y: 79.75))
        bezier3Path.addCurve(to: CGPoint(x: 148.84, y: 79.7), controlPoint1: CGPoint(x: 148.74, y: 79.76), controlPoint2: CGPoint(x: 148.84, y: 79.7))
        bezier3Path.addCurve(to: CGPoint(x: 150, y: 79.45), controlPoint1: CGPoint(x: 149.21, y: 79.54), controlPoint2: CGPoint(x: 149.61, y: 79.45))
        bezier3Path.addLine(to: CGPoint(x: 150.08, y: 79.45))
        bezier3Path.close()
        iconColor.setFill()
        bezier3Path.fill()
        iconColor.setStroke()
    ...
    @objc dynamic public class func drawViewArtworkIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawCalendarIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawPlayIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Polygon Drawing
        context.saveGState()
        context.translateBy(x: 160.55, y: 150)

        let polygonPath = UIBezierPath()
        polygonPath.move(to: CGPoint(x: -50.87, y: -62.93))
        polygonPath.addCurve(to: CGPoint(x: 8, y: -32.74), controlPoint1: CGPoint(x: -37.68, y: -56.43), controlPoint2: CGPoint(x: -8.31, y: -41.24))
        polygonPath.addCurve(to: CGPoint(x: 56.39, y: -7.04), controlPoint1: CGPoint(x: 30, y: -21.27), controlPoint2: CGPoint(x: 39.99, y: -16.3))
        polygonPath.addCurve(to: CGPoint(x: 61.7, y: -0), controlPoint1: CGPoint(x: 60.49, y: -4.72), controlPoint2: CGPoint(x: 61.69, y: -1.72))
        polygonPath.addCurve(to: CGPoint(x: 56.39, y: 6.38), controlPoint1: CGPoint(x: 61.72, y: 1.72), controlPoint2: CGPoint(x: 60.78, y: 3.67))
        polygonPath.addCurve(to: CGPoint(x: 8, y: 32.37), controlPoint1: CGPoint(x: 38.85, y: 17.2), controlPoint2: CGPoint(x: 29.3, y: 20.82))
        polygonPath.addCurve(to: CGPoint(x: -50.87, y: 62.94), controlPoint1: CGPoint(x: -8.21, y: 41.16), controlPoint2: CGPoint(x: -35.73, y: 55.27))
        polygonPath.addCurve(to: CGPoint(x: -61.7, y: 56.33), controlPoint1: CGPoint(x: -56.77, y: 65.93), controlPoint2: CGPoint(x: -61.73, y: 63.26))
        polygonPath.addCurve(to: CGPoint(x: -61.7, y: -0), controlPoint1: CGPoint(x: -61.58, y: 30.2), controlPoint2: CGPoint(x: -61.7, y: 47.33))
        polygonPath.addCurve(to: CGPoint(x: -61.7, y: -55.89), controlPoint1: CGPoint(x: -61.7, y: -48.84), controlPoint2: CGPoint(x: -61.55, y: -21.07))
        polygonPath.addCurve(to: CGPoint(x: -50.87, y: -62.93), controlPoint1: CGPoint(x: -61.74, y: -64.59), controlPoint2: CGPoint(x: -55.89, y: -65.41))
        polygonPath.close()
        iconColor.setFill()
        polygonPath.fill()
    ...
    @objc dynamic public class func drawStopIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 90, y: 90, width: 120, height: 120), cornerRadius: 10)
        iconColor.setFill()
        rectanglePath.fill()
    ...
    @objc dynamic public class func drawTrackListingIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawPlusIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier 3 Drawing
        context.saveGState()
        context.translateBy(x: 152.5, y: 148.06)
        context.rotate(by: -45 * CGFloat.pi/180)

        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 50.03, y: -61.81))
        bezier3Path.addCurve(to: CGPoint(x: 55.35, y: -57.31), controlPoint1: CGPoint(x: 51.73, y: -60.92), controlPoint2: CGPoint(x: 52.94, y: -59.72))
        bezier3Path.addLine(to: CGPoint(x: 57.77, y: -54.89))
        bezier3Path.addCurve(to: CGPoint(x: 62.11, y: -49.83), controlPoint1: CGPoint(x: 60.18, y: -52.48), controlPoint2: CGPoint(x: 61.38, y: -51.27))
        bezier3Path.addLine(to: CGPoint(x: 62.27, y: -49.57))
        bezier3Path.addCurve(to: CGPoint(x: 62.27, y: -43.47), controlPoint1: CGPoint(x: 63.17, y: -47.64), controlPoint2: CGPoint(x: 63.17, y: -45.4))
        bezier3Path.addCurve(to: CGPoint(x: 57.77, y: -38.15), controlPoint1: CGPoint(x: 61.38, y: -41.77), controlPoint2: CGPoint(x: 60.18, y: -40.56))
        bezier3Path.addLine(to: CGPoint(x: 19.62, y: -0))
        bezier3Path.addCurve(to: CGPoint(x: 57.77, y: 38.15), controlPoint1: CGPoint(x: 34.03, y: 14.41), controlPoint2: CGPoint(x: 57.77, y: 38.15))
        bezier3Path.addCurve(to: CGPoint(x: 62.11, y: 43.21), controlPoint1: CGPoint(x: 60.18, y: 40.56), controlPoint2: CGPoint(x: 61.38, y: 41.77))
        bezier3Path.addLine(to: CGPoint(x: 62.27, y: 43.47))
        bezier3Path.addCurve(to: CGPoint(x: 62.27, y: 49.57), controlPoint1: CGPoint(x: 63.17, y: 45.4), controlPoint2: CGPoint(x: 63.17, y: 47.64))
        bezier3Path.addCurve(to: CGPoint(x: 57.77, y: 54.89), controlPoint1: CGPoint(x: 61.38, y: 51.27), controlPoint2: CGPoint(x: 60.18, y: 52.48))
        bezier3Path.addLine(to: CGPoint(x: 55.35, y: 57.31))
        bezier3Path.addCurve(to: CGPoint(x: 50.29, y: 61.65), controlPoint1: CGPoint(x: 52.94, y: 59.72), controlPoint2: CGPoint(x: 51.73, y: 60.92))
        bezier3Path.addLine(to: CGPoint(x: 50.03, y: 61.81))
        bezier3Path.addCurve(to: CGPoint(x: 43.93, y: 61.81), controlPoint1: CGPoint(x: 48.1, y: 62.71), controlPoint2: CGPoint(x: 45.87, y: 62.71))
        bezier3Path.addCurve(to: CGPoint(x: 38.61, y: 57.31), controlPoint1: CGPoint(x: 42.23, y: 60.92), controlPoint2: CGPoint(x: 41.02, y: 59.72))
        bezier3Path.addCurve(to: CGPoint(x: -0, y: 18.7), controlPoint1: CGPoint(x: 38.61, y: 57.31), controlPoint2: CGPoint(x: 14.36, y: 33.06))
        bezier3Path.addCurve(to: CGPoint(x: -38.61, y: 57.31), controlPoint1: CGPoint(x: -14.36, y: 33.06), controlPoint2: CGPoint(x: -38.61, y: 57.31))
        bezier3Path.addCurve(to: CGPoint(x: -43.67, y: 61.65), controlPoint1: CGPoint(x: -41.02, y: 59.72), controlPoint2: CGPoint(x: -42.23, y: 60.92))
        bezier3Path.addLine(to: CGPoint(x: -43.93, y: 61.81))
        bezier3Path.addCurve(to: CGPoint(x: -50.03, y: 61.81), controlPoint1: CGPoint(x: -45.87, y: 62.71), controlPoint2: CGPoint(x: -48.1, y: 62.71))
        bezier3Path.addCurve(to: CGPoint(x: -55.35, y: 57.31), controlPoint1: CGPoint(x: -51.73, y: 60.92), controlPoint2: CGPoint(x: -52.94, y: 59.72))
        bezier3Path.addLine(to: CGPoint(x: -57.77, y: 54.89))
        bezier3Path.addCurve(to: CGPoint(x: -62.11, y: 49.83), controlPoint1: CGPoint(x: -60.18, y: 52.48), controlPoint2: CGPoint(x: -61.38, y: 51.27))
        bezier3Path.addLine(to: CGPoint(x: -62.27, y: 49.57))
