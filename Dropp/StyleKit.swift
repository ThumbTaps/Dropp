...
//  Dropp
//
//  Created by Jeffery Jackson, Jr. on 8/5/18.
...
public class StyleKit : NSObject {
    ...
    @objc dynamic public class func drawCloseIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        ...
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 11.1, y: -77.65))
        bezier2Path.addCurve(to: CGPoint(x: 12, y: -66.88), controlPoint1: CGPoint(x: 12, y: -74.8), controlPoint2: CGPoint(x: 12, y: -72.16))
        bezier2Path.addCurve(to: CGPoint(x: 12, y: -12), controlPoint1: CGPoint(x: 12, y: -66.88), controlPoint2: CGPoint(x: 12, y: -39.87))
        bezier2Path.addLine(to: CGPoint(x: 48.31, y: -12))
        bezier2Path.addCurve(to: CGPoint(x: 77.19, y: -11.21), controlPoint1: CGPoint(x: 72.16, y: -12), controlPoint2: CGPoint(x: 74.8, y: -12))
        bezier2Path.addLine(to: CGPoint(x: 77.65, y: -11.1))
        bezier2Path.addCurve(to: CGPoint(x: 85, y: -0.6), controlPoint1: CGPoint(x: 82.06, y: -9.49), controlPoint2: CGPoint(x: 85, y: -5.3))
        bezier2Path.addCurve(to: CGPoint(x: 85, y: -0), controlPoint1: CGPoint(x: 85, y: -0), controlPoint2: CGPoint(x: 85, y: -0))
        bezier2Path.addLine(to: CGPoint(x: 85, y: 0.6))
        bezier2Path.addCurve(to: CGPoint(x: 77.65, y: 11.1), controlPoint1: CGPoint(x: 85, y: 5.3), controlPoint2: CGPoint(x: 82.06, y: 9.49))
        bezier2Path.addCurve(to: CGPoint(x: 66.88, y: 12), controlPoint1: CGPoint(x: 74.8, y: 12), controlPoint2: CGPoint(x: 72.16, y: 12))
        bezier2Path.addLine(to: CGPoint(x: 48.31, y: 12))
        bezier2Path.addCurve(to: CGPoint(x: 12, y: 12), controlPoint1: CGPoint(x: 34.78, y: 12), controlPoint2: CGPoint(x: 22.73, y: 12))
        bezier2Path.addCurve(to: CGPoint(x: 12, y: 48.31), controlPoint1: CGPoint(x: 12, y: 32.18), controlPoint2: CGPoint(x: 12, y: 48.31))
        bezier2Path.addCurve(to: CGPoint(x: 11.21, y: 77.19), controlPoint1: CGPoint(x: 12, y: 72.16), controlPoint2: CGPoint(x: 12, y: 74.8))
        bezier2Path.addLine(to: CGPoint(x: 11.1, y: 77.65))
        bezier2Path.addCurve(to: CGPoint(x: 0.6, y: 85), controlPoint1: CGPoint(x: 9.49, y: 82.06), controlPoint2: CGPoint(x: 5.3, y: 85))
        bezier2Path.addLine(to: CGPoint(x: -0.6, y: 85))
        bezier2Path.addCurve(to: CGPoint(x: -11.1, y: 77.65), controlPoint1: CGPoint(x: -5.3, y: 85), controlPoint2: CGPoint(x: -9.49, y: 82.06))
        bezier2Path.addCurve(to: CGPoint(x: -12, y: 66.88), controlPoint1: CGPoint(x: -12, y: 74.8), controlPoint2: CGPoint(x: -12, y: 72.16))
        bezier2Path.addLine(to: CGPoint(x: -12, y: 48.31))
        bezier2Path.addCurve(to: CGPoint(x: -12, y: 11.99), controlPoint1: CGPoint(x: -12, y: 34.77), controlPoint2: CGPoint(x: -12, y: 22.72))
        bezier2Path.addCurve(to: CGPoint(x: -77.19, y: 11.21), controlPoint1: CGPoint(x: -73.24, y: 11.97), controlPoint2: CGPoint(x: -75.29, y: 11.84))
        bezier2Path.addLine(to: CGPoint(x: -77.65, y: 11.1))
        bezier2Path.addCurve(to: CGPoint(x: -85, y: 0.6), controlPoint1: CGPoint(x: -82.06, y: 9.49), controlPoint2: CGPoint(x: -85, y: 5.3))
        bezier2Path.addCurve(to: CGPoint(x: -85, y: -0), controlPoint1: CGPoint(x: -85, y: -0), controlPoint2: CGPoint(x: -85, y: -0))
        bezier2Path.addLine(to: CGPoint(x: -85, y: -0.6))
        bezier2Path.addCurve(to: CGPoint(x: -77.65, y: -11.1), controlPoint1: CGPoint(x: -85, y: -5.3), controlPoint2: CGPoint(x: -82.06, y: -9.49))
        bezier2Path.addCurve(to: CGPoint(x: -66.88, y: -12), controlPoint1: CGPoint(x: -74.8, y: -12), controlPoint2: CGPoint(x: -72.16, y: -12))
        bezier2Path.addLine(to: CGPoint(x: -11.99, y: -12))
        bezier2Path.addCurve(to: CGPoint(x: -11.21, y: -77.19), controlPoint1: CGPoint(x: -11.97, y: -73.24), controlPoint2: CGPoint(x: -11.84, y: -75.29))
        bezier2Path.addLine(to: CGPoint(x: -11.1, y: -77.65))
        bezier2Path.addCurve(to: CGPoint(x: -0.6, y: -85), controlPoint1: CGPoint(x: -9.49, y: -82.06), controlPoint2: CGPoint(x: -5.3, y: -85))
        bezier2Path.addLine(to: CGPoint(x: 0.6, y: -85))
        bezier2Path.addCurve(to: CGPoint(x: 11.1, y: -77.65), controlPoint1: CGPoint(x: 5.3, y: -85), controlPoint2: CGPoint(x: 9.49, y: -82.06))
    ...
    @objc dynamic public class func drawPlusIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, iconColor: UIColor = UIColor(red: 0.200, green: 0.200, blue: 0.200, alpha: 1.000)) {
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 161.1, y: 72.35))
        bezier2Path.addCurve(to: CGPoint(x: 162, y: 83.12), controlPoint1: CGPoint(x: 162, y: 75.2), controlPoint2: CGPoint(x: 162, y: 77.84))
        bezier2Path.addCurve(to: CGPoint(x: 162, y: 138), controlPoint1: CGPoint(x: 162, y: 83.12), controlPoint2: CGPoint(x: 162, y: 110.13))
        bezier2Path.addLine(to: CGPoint(x: 198.31, y: 138))
        bezier2Path.addCurve(to: CGPoint(x: 227.19, y: 138.79), controlPoint1: CGPoint(x: 222.16, y: 138), controlPoint2: CGPoint(x: 224.8, y: 138))
        bezier2Path.addLine(to: CGPoint(x: 227.65, y: 138.9))
        bezier2Path.addCurve(to: CGPoint(x: 235, y: 149.4), controlPoint1: CGPoint(x: 232.06, y: 140.51), controlPoint2: CGPoint(x: 235, y: 144.7))
        bezier2Path.addCurve(to: CGPoint(x: 235, y: 150), controlPoint1: CGPoint(x: 235, y: 150), controlPoint2: CGPoint(x: 235, y: 150))
        bezier2Path.addLine(to: CGPoint(x: 235, y: 150.6))
        bezier2Path.addCurve(to: CGPoint(x: 227.65, y: 161.1), controlPoint1: CGPoint(x: 235, y: 155.3), controlPoint2: CGPoint(x: 232.06, y: 159.49))
        bezier2Path.addCurve(to: CGPoint(x: 216.88, y: 162), controlPoint1: CGPoint(x: 224.8, y: 162), controlPoint2: CGPoint(x: 222.16, y: 162))
        bezier2Path.addLine(to: CGPoint(x: 198.31, y: 162))
        bezier2Path.addCurve(to: CGPoint(x: 162, y: 162), controlPoint1: CGPoint(x: 184.78, y: 162), controlPoint2: CGPoint(x: 172.73, y: 162))
        bezier2Path.addCurve(to: CGPoint(x: 162, y: 198.31), controlPoint1: CGPoint(x: 162, y: 182.18), controlPoint2: CGPoint(x: 162, y: 198.31))
        bezier2Path.addCurve(to: CGPoint(x: 161.21, y: 227.19), controlPoint1: CGPoint(x: 162, y: 222.16), controlPoint2: CGPoint(x: 162, y: 224.8))
        bezier2Path.addLine(to: CGPoint(x: 161.1, y: 227.65))
        bezier2Path.addCurve(to: CGPoint(x: 150.6, y: 235), controlPoint1: CGPoint(x: 159.49, y: 232.06), controlPoint2: CGPoint(x: 155.3, y: 235))
        bezier2Path.addLine(to: CGPoint(x: 149.4, y: 235))
        bezier2Path.addCurve(to: CGPoint(x: 138.9, y: 227.65), controlPoint1: CGPoint(x: 144.7, y: 235), controlPoint2: CGPoint(x: 140.51, y: 232.06))
        bezier2Path.addCurve(to: CGPoint(x: 138, y: 216.88), controlPoint1: CGPoint(x: 138, y: 224.8), controlPoint2: CGPoint(x: 138, y: 222.16))
        bezier2Path.addLine(to: CGPoint(x: 138, y: 198.31))
        bezier2Path.addCurve(to: CGPoint(x: 138, y: 161.99), controlPoint1: CGPoint(x: 138, y: 184.77), controlPoint2: CGPoint(x: 138, y: 172.72))
        bezier2Path.addCurve(to: CGPoint(x: 72.81, y: 161.21), controlPoint1: CGPoint(x: 76.76, y: 161.97), controlPoint2: CGPoint(x: 74.71, y: 161.84))
        bezier2Path.addLine(to: CGPoint(x: 72.35, y: 161.1))
        bezier2Path.addCurve(to: CGPoint(x: 65, y: 150.6), controlPoint1: CGPoint(x: 67.94, y: 159.49), controlPoint2: CGPoint(x: 65, y: 155.3))
        bezier2Path.addCurve(to: CGPoint(x: 65, y: 150), controlPoint1: CGPoint(x: 65, y: 150), controlPoint2: CGPoint(x: 65, y: 150))
        bezier2Path.addLine(to: CGPoint(x: 65, y: 149.4))
        bezier2Path.addCurve(to: CGPoint(x: 72.35, y: 138.9), controlPoint1: CGPoint(x: 65, y: 144.7), controlPoint2: CGPoint(x: 67.94, y: 140.51))
        bezier2Path.addCurve(to: CGPoint(x: 83.12, y: 138), controlPoint1: CGPoint(x: 75.2, y: 138), controlPoint2: CGPoint(x: 77.84, y: 138))
        bezier2Path.addLine(to: CGPoint(x: 138.01, y: 138))
        bezier2Path.addCurve(to: CGPoint(x: 138.79, y: 72.81), controlPoint1: CGPoint(x: 138.03, y: 76.76), controlPoint2: CGPoint(x: 138.16, y: 74.71))
        bezier2Path.addLine(to: CGPoint(x: 138.9, y: 72.35))
        bezier2Path.addCurve(to: CGPoint(x: 149.4, y: 65), controlPoint1: CGPoint(x: 140.51, y: 67.94), controlPoint2: CGPoint(x: 144.7, y: 65))
        bezier2Path.addLine(to: CGPoint(x: 150.6, y: 65))
        bezier2Path.addCurve(to: CGPoint(x: 161.1, y: 72.35), controlPoint1: CGPoint(x: 155.3, y: 65), controlPoint2: CGPoint(x: 159.49, y: 67.94))
        bezier2Path.close()
        iconColor.setFill()
        bezier2Path.fill()
